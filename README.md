...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|3521|354|36|* [jwt-go](https://github.com/dgrijalva/jwt-go) - Golang implementation of JSON Web Tokens (JWT).|
|2360|224|16|* [casbin](https://github.com/hsluoyz/casbin) - Authorization library that supports access control models like ACL, RBAC, ABAC.|
...
|1586|398|57|* [oauth2](https://github.com/golang/oauth2) - Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine and App Engine support.|
...
|856|112|15|* [go-jose](https://github.com/square/go-jose) - Fairly complete implementation of the JOSE working group's JSON Web Token, JSON Web Signatures, and JSON Web Encryption specs.|
|846|110|8|* [go-oauth2-server](https://github.com/RichardKnop/go-oauth2-server) - Standalone, specification-compliant,  OAuth2 server written in Golang.|
...
|712|109|2|* [gorbac](https://github.com/mikespook/gorbac) - provides a lightweight role-based access control (RBAC) implementation in Golang.|
|581|45|13|* [loginsrv](https://github.com/tarent/loginsrv) - JWT login microservice with plugable backends such as OAuth2 (Github), htpasswd, osiam.|
...
|139|16|2|* [httpauth](https://github.com/goji/httpauth) - HTTP Authentication middleware.|
...
|110|6|4|* [paseto](https://github.com/o1egl/paseto) - Golang implementation of Platform-Agnostic Security Tokens (PASETO)|
...
|60|6|5|* [session](https://github.com/icza/session) - Go session management for web servers (including support for Google App Engine - GAE).|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|8077|706|107|* [urfave/cli](https://github.com/urfave/cli) - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).|
|7468|606|119|* [cobra](https://github.com/spf13/cobra) - Commander for modern Go CLI interactions.|
|4072|318|215|* [drive](https://github.com/odeke-em/drive) - Google Drive client for the commandline.|
|1845|139|16|* [kingpin](https://github.com/alecthomas/kingpin) - Command line and flag parser supporting sub commands.|
...
|1013|133|16|* [go-flags](https://github.com/jessevdk/go-flags) - go command line option parser.|
|935|71|15|* [docopt.go](https://github.com/docopt/docopt.go) - Command-line arguments parser that will make you smile.|
|818|71|21|* [cli-init](https://github.com/tcnksm/gcli) - The easy way to start building Golang command line applications.|
|804|63|10|* [mitchellh/cli](https://github.com/mitchellh/cli) - Go library for implementing command-line interfaces.|
|513|39|7|* [mow.cli](https://github.com/jawher/mow.cli) - Go library for building CLI applications with sophisticated flag and argument parsing and validation.|
|473|24|2|* [go-arg](https://github.com/alexflint/go-arg) - Struct-based argument parsing in Go.|
|447|24|0|* [complete](https://github.com/posener/complete) - Write bash completions in Go + Go command bash completion.|
|444|63|2|* [liner](https://github.com/peterh/liner) - Go readline-like library for command-line interfaces.|
|380|113|19|* [pflag](https://github.com/spf13/pflag) - Drop-in replacement for Go's flag package, implementing POSIX/GNU-style --flags.|
|366|31|16|* [cli](https://github.com/mkideal/cli) - Feature-rich and easy to use command-line package based on golang struct tags.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|7362|429|84|* [termui](https://github.com/gizak/termui) - Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib).|
|2801|234|45|* [termbox-go](https://github.com/nsf/termbox-go) - Termbox is a library for creating cross-platform text-based interfaces.|
|2433|160|28|* [gocui](https://github.com/jroimartin/gocui) - Minimalist Go library aimed at creating Console User Interfaces.|
|2338|192|9|* [color](https://github.com/fatih/color) - Versatile package for colored terminal output.|
|1506|47|15|* [go-prompt](https://github.com/c-bata/go-prompt) - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit).|
|1326|72|15|* [tui-go](https://github.com/marcusolsson/tui-go) - Go UI library for building rich terminal applications.|
...
|646|29|12|* [uilive](https://github.com/gosuri/uilive) - Library for updating terminal output in realtime.|
|429|16|2|* [uitable](https://github.com/gosuri/uitable) - Library to improve readability in terminal apps using tabular data.|
|292|10|1|* [aurora](https://github.com/logrusorgru/aurora) - ANSI terminal colors that supports fmt.Printf/Sprintf.|
...
|217|22|0|* [mpb](https://github.com/vbauerster/mpb) - Multi progress bar for terminal applications.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|5195|503|225|* [viper](https://github.com/spf13/viper) - Go configuration with fangs.|
|1192|75|10|* [godotenv](https://github.com/joho/godotenv) - Go port of Ruby's dotenv library (Loads environment variables from `.env`).|
|926|146|5|* [ini](https://github.com/go-ini/ini) - Go package to read and write INI files.|
|472|46|3|* [env](https://github.com/caarlos0/env) - Parse environment variables to Go structs (with defaults).|
|223|11|1|* [store](https://github.com/tucnak/store) - Lightweight configuration manager for Go.|
...
|122|12|1|* [hjson](https://github.com/hjson/hjson-go) - Human JSON, a configuration file format for humans. Relaxed syntax, fewer mistakes, more comments.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|14220|1503|102|* [drone](https://github.com/drone/drone) - Drone is a Continuous Integration platform built on Docker, written in Go.|
|478|73|14|* [goveralls](https://github.com/mattn/goveralls) - Go integration for Coveralls.io continuous code coverage tracking system.|
...
|81|13|10|* [go-libsass](https://github.com/wellington/go-libsass) - Go wrapper to the 100% Sass compatible libsass project.|
## Data Structures
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|4072|393|14|* [gods](https://github.com/emirpasic/gods) - Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.|
|4059|433|14|* [go-datastructures](https://github.com/Workiva/go-datastructures) - Collection of useful, performant, and thread-safe data structures.|
...
|733|83|4|* [golang-set](https://github.com/deckarep/golang-set) - Thread-Safe and Non-Thread-Safe high-performance sets for Go.|
...
|516|56|27|* [gota](https://github.com/kniren/gota) - Implementation of dataframes, series, and data wrangling methods for Go.|
|440|79|4|* [willf/bloom](https://github.com/willf/bloom) - Go package implementing Bloom filters.|
|403|39|39|* [roaring](https://github.com/RoaringBitmap/roaring) - Go package implementing compressed bitsets.|
|365|68|4|* [bitset](https://github.com/willf/bitset) - Go package implementing bitsets.|
|305|19|4|* [cuckoofilter](https://github.com/seiflotfy/cuckoofilter) - Cuckoo filter: a good alternative to a counting bloom filter implemented in Go.|
...
|261|36|6|* [trie](https://github.com/derekparker/trie) - Trie implementation in Go.|
...
|83|10|0|* [binpacker](https://github.com/zhuangsirui/binpacker) - Binary packer and unpacker helps user build custom binary stream.|
...
|50|6|1|* [merkletree](https://github.com/cbergoon/merkletree) - Implementation of a merkle tree providing an efficient and secure verification of the contents of data structures.|
...
|4|0|0|* [algorithms](https://github.com/shady831213/algorithms) - Algorithms and data structures.CLRS study.|
## Database
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|16276|2061|250|* [prometheus](https://github.com/prometheus/prometheus) - Monitoring system and time series database.|
|13374|1379|1703|* [cockroach](https://github.com/cockroachdb/cockroach) - Scalable, Geo-Replicated, Transactional Datastore.|
|13323|1922|695|* [influxdb](https://github.com/influxdb/influxdb) - Scalable datastore for metrics, events, and real-time analytics.|
|13218|1790|405|* [tidb](https://github.com/pingcap/tidb) - TiDB is a distributed SQL database. Inspired by the design of Google F1.|
|8477|729|84|* [bolt](https://github.com/boltdb/bolt) - Low-level key/value database for Go.|
|6422|754|10|* [groupcache](https://github.com/golang/groupcache) - Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases.|
|5958|770|202|* [vitess](https://github.com/youtube/vitess) - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.|
|5529|357|156|* [dgraph](https://github.com/dgraph-io/dgraph) - Scalable, Distributed, Low Latency, High Throughput Graph Database.|
|5020|359|39|* [pgweb](https://github.com/sosedoff/pgweb) - Web-based PostgreSQL database browser.|
|4618|371|171|* [jaeger](https://github.com/jaegertracing/jaeger) - A distributed tracing system.|
|3761|197|46|* [rqlite](https://github.com/rqlite/rqlite) - The lightweight, distributed, relational database built on SQLite.|
|3696|198|15|* [badger](https://github.com/dgraph-io/badger) - Fast key-value store in Go.|
|3448|706|65|* [kingshard](https://github.com/flike/kingshard) - kingshard is a high performance proxy for MySQL powered by Golang.|
|2533|296|93|* [ledisdb](https://github.com/siddontang/ledisdb) - Ledisdb is a high performance NoSQL like Redis based on LevelDB.|
|2263|348|96|* [migrate](https://github.com/mattes/migrate) - Database migrations. CLI and Golang library.|
|2203|281|28|* [goleveldb](https://github.com/syndtr/goleveldb) - Implementation of the [LevelDB](https://github.com/google/leveldb) key/value database in Go.|
|2065|196|19|* [tiedot](https://github.com/HouzuoGuo/tiedot) - Your NoSQL database powered by Golang.|
|1855|117|0|* [buntdb](https://github.com/tidwall/buntdb) - Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support.|
|1677|80|55|* [pREST](https://github.com/nuveo/prest) - Serve a RESTful API from any PostgreSQL database.|
|1611|269|35|* [go-cache](https://github.com/pmylund/go-cache) - In-memory key:value store/cache (similar to Memcached) library for Go, suitable for single-machine applications.|
...
|1500|127|41|* [Squirrel](https://github.com/Masterminds/squirrel) - Go library that helps you build SQL queries.|
|1462|113|5|* [BigCache](https://github.com/allegro/bigcache) - Efficient key/value cache for gigabytes of data.|
|1313|286|102|* [go-mysql-elasticsearch](https://github.com/siddontang/go-mysql-elasticsearch) - Sync your MySQL data into Elasticsearch automatically.|
|1204|188|108|* [orchestrator](https://github.com/github/orchestrator) - MySQL replication topology manager & visualizer.|
|989|264|46|* [go-mysql](https://github.com/siddontang/go-mysql) - Go toolset to handle MySQL protocol and replication.|
|943|99|41|* [sql-migrate](https://github.com/rubenv/sql-migrate) - Database migration tool. Allows embedding migrations into the application using go-bindata.|
|587|54|5|* [diskv](https://github.com/peterbourgon/diskv) - Home-grown disk-backed key-value store.|
|520|49|28|* [dat](https://github.com/mgutz/dat) - Go Postgres Data Access Toolkit.|
|498|201|5|* [cache2go](https://github.com/muesli/cache2go) - In-memory key:value cache which supports automatic invalidation based on timeouts.|
|498|25|40|* [moss](https://github.com/couchbase/moss) - Moss is a simple LSM key-value storage engine written in 100% Go.|
|486|18|2|* [eliasdb](https://github.com/krotik/eliasdb) - Dependency-free, transactional graph database with REST API, phrase search and SQL-like query language.|
...
|328|69|3|* [levigo](https://github.com/jmhodges/levigo) - Levigo is a Go wrapper for LevelDB.|
|301|31|1|* [gendry](https://github.com/didi/gendry) - Non-invasive SQL builder and powerful data binder.|
|235|32|15|* [ozzo-dbx](https://github.com/go-ozzo/ozzo-dbx) - Powerful data retrieval methods as well as DB-agnostic query building capabilities.|
|159|17|9|* [piladb](https://github.com/fern4lvarez/piladb) - Lightweight RESTful database engine based on stack data structures.|
|143|12|3|* [gormigrate](https://github.com/go-gormigrate/gormigrate) - Database schema migration helper for Gorm ORM.|
...
|113|11|3|* [sqrl](https://github.com/elgris/sqrl) - SQL query builder, fork of Squirrel with improved performance.|
...
|25|11|0|* [godbal](https://github.com/xujiajun/godbal) - Database Abstraction Layer (dbal) for go. Support SQL builder and get result easily.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|11323|990|68|    * [cayley](https://github.com/google/cayley) - Graph database with support for multiple backends.|
|5340|1080|58|    * [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) - MySQL driver for Go.|
|4360|682|5|    * [redigo](https://github.com/gomodule/redigo) - Redigo is a Go client for the Redis database.|
|4320|344|119|    * [bleve](https://github.com/blevesearch/bleve) - Modern text indexing library for go.|
|3830|511|160|    * [pq](https://github.com/lib/pq) - Pure Go Postgres driver for database/sql.|
|3522|155|18|    * [riot](https://github.com/go-ego/riot) - Go Open Source, Distributed, Simple and efficient Search Engine|
|3358|489|25|    * [redis](https://github.com/go-redis/redis) - Redis client for Golang.|
|2526|519|15|    * [elastic](https://github.com/olivere/elastic) - Elasticsearch client for Go.|
|2445|518|90|    * [go-sqlite3](https://github.com/mattn/go-sqlite3) - SQLite3 driver for go that uses database/sql.|
...
|677|60|11|    * [mgo](https://github.com/globalsign/mgo) - MongoDB driver for the Go language that implements a rich and well tested selection of features under a very simple API following standard Go idioms|
|563|205|17|    * [redis](https://github.com/hoisie/redis) - Simple, powerful Redis client for Go.|
|387|32|1|    * [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) - Official MongoDB driver for the Go language.|
|335|52|16|    * [neoism](https://github.com/jmcvetta/neoism) - Neo4j client for Golang.|
|289|150|65|    * [go-oci8](https://github.com/mattn/go-oci8) - Oracle driver for go that uses database/sql.|
...
|176|17|0|    * [redis](https://github.com/bsm/redeo) - Redis-protocol compatible TCP servers/services.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|1687|88|5|* [now](https://github.com/jinzhu/now) - Now is a time toolkit for golang.|
|610|22|6|* [dateparse](https://github.com/araddon/dateparse) - Parse date's without knowing format in advance.|
...
|178|17|0|* [durafmt](https://github.com/hako/durafmt) - Time duration formatting library for Go.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|9897|1014|44|* [go-kit](https://github.com/go-kit/kit) - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.|
|5511|1064|101|* [grpc-go](https://github.com/grpc/grpc-go) - The Go language implementation of gRPC. HTTP/2 based RPC.|
|4384|336|0|* [micro](https://github.com/micro/micro) - Pluggable microservice toolkit and distributed systems platform.|
|4105|448|60|* [NATS](https://github.com/nats-io/gnatsd) - Lightweight, high performance messaging system for microservices, IoT, and cloud native systems.|
|2291|397|5|* [rpcx](https://github.com/smallnest/rpcx) - Distributed pluggable RPC service framework like alibaba Dubbo.|
|2174|236|21|* [torrent](https://github.com/anacrolix/torrent) - BitTorrent client package.|
|2035|164|9|* [glow](https://github.com/chrislusf/glow) - Easy-to-Use scalable distributed big data processing, Map-Reduce, DAG execution, all in pure Go.|
|1851|235|83|* [raft](https://github.com/hashicorp/raft) - Golang implementation of the Raft consensus protocol, by HashiCorp.|
|1785|361|188|* [tendermint](https://github.com/tendermint/tendermint) - High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols.|
|1331|124|17|* [gleam](https://github.com/chrislusf/gleam) - Fast and scalable distributed map/reduce system written in pure Go and Luajit, combining Go's high concurrency with Luajit's high performance, runs standalone or distributed.|
|1164|86|14|* [emitter-io](https://github.com/emitter-io/emitter) - High performance, distributed, secure and low latency publish-subscribe platform built with MQTT, Websockets and love.|
|754|145|12|* [hprose](https://github.com/hprose/hprose-golang) - Very newbility RPC Library, support 25+ languages now.|
|476|24|8|* [heimdall](https://github.com/gojektech/heimdall) - An enchanced http client with retry and hystrix capabilities.|
|448|54|13|* [gorpc](https://github.com/valyala/gorpc) - Simple, fast and scalable RPC library for high load.|
|437|49|10|* [KrakenD](https://github.com/devopsfaith/krakend) - Ultra performant API Gateway framework with middlewares.|
...
|183|14|1|* [go-jump](https://github.com/dgryski/go-jump) - Port of Google's "Jump" Consistent Hash function.|
...
|97|2|0|* [consistent](https://github.com/buraksezer/consistent) - Consistent hashing with bounded loads.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|3404|212|89|* [MailHog](https://github.com/mailhog/MailHog) - Email and SMTP testing with web and API interface.|
|1242|57|11|* [hermes](https://github.com/matcornic/hermes) - Golang package that generates clean, responsive HTML e-mails.|
|875|108|17|* [email](https://github.com/jordan-wright/email) - A robust and flexible email library for Go.|
|418|54|23|* [go-imap](https://github.com/emersion/go-imap) - IMAP library for clients and servers.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|3730|331|74|* [otto](https://github.com/robertkrimen/otto) - JavaScript interpreter written in Go.|
|2117|205|18|* [gopher-lua](https://github.com/yuin/gopher-lua) - Lua 5.1 VM and compiler written in Go.|
...
|662|53|21|* [anko](https://github.com/mattn/anko) - Scriptable interpreter written in Go.|
|568|64|5|* [go-duktape](https://github.com/olebedev/go-duktape) - Duktape JavaScript engine bindings for Go.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|1432|146|42|* [afero](https://github.com/spf13/afero) - FileSystem Abstraction System for Go.|
|341|39|31|* [notify](https://github.com/rjeczalik/notify) - File system event notification library with simple API, similar to os/signal.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|917|139|21|* [decimal](https://github.com/shopspring/decimal) - Arbitrary-precision fixed-point decimal numbers.|
|548|43|4|* [go-finance](https://github.com/FlashBoys/go-finance) - Comprehensive financial markets data in Go.|
|420|20|2|* [go-money](https://github.com/rhymond/go-money) - Implementation of Fowler's Money pattern.|
|371|20|2|* [accounting](https://github.com/leekchan/accounting) - money and currency formatting for golang.|
...
|38|1|0|* [techan](https://github.com/sdcoffey/techan) - Technical analysis library with advanced market analysis and trading strategies.|
|16|2|0|* [transaction](https://github.com/claygod/transaction) - Embedded transactional database of accounts, running in multithreaded mode.|
...
|260|11|4|* [form](https://github.com/go-playground/form) - Decodes url.Values into Go value(s) and Encodes Go value(s) into url.Values. Dual Array and Full map support.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|2070|597|5|* [Leaf](https://github.com/name5566/leaf) - Lightweight game server framework.|
|1372|68|16|* [Pixel](https://github.com/faiface/pixel) - Hand-crafted 2D game library in Go.|
...
|863|68|99|* [Ebiten](https://github.com/hajimehoshi/ebiten) - dead simple 2D game library in Go.|
|854|108|11|* [go-sdl2](https://github.com/veandco/go-sdl2) - Go bindings for the [Simple DirectMedia Layer](https://www.libsdl.org/).|
|774|72|31|* [engo](https://github.com/EngoEngine/engo) - Engo is an open-source 2D game engine written in Go. It follows the Entity-Component-System paradigm.|
|600|107|11|* [goworld](https://github.com/xiaonanln/goworld) - Scalable game server engine, featuring space-entity framework and hot-swapping|
|477|19|18|* [Oak](https://github.com/oakmound/oak) - Pure Go game engine.|
|443|51|4|* [nano](https://github.com/lonnng/nano) - Lightweight, facility, high performance golang based game server framework|
|358|23|79|* [Azul3D](https://github.com/azul3d/engine) - 3D game engine written in Go.|
...
|877|66|32|* [gen](https://github.com/clipperhouse/gen) - Code generation tool for ‘generics’-like functionality.|
|682|32|0|* [jennifer](https://github.com/dave/jennifer) - Generate arbitrary Go code without templates.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|4630|222|52|* [Tile38](https://github.com/tidwall/tile38) - Geolocation DB with spatial index and realtime geofencing.|
...
|6|1|0|* [geoserver](https://github.com/hishamkaram/geoserver) - geoserver Is a Go Package For Manipulating a GeoServer Instance via the GeoServer REST API.|
## Go Compilers
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|6794|313|173|* [gopherjs](https://github.com/gopherjs/gopherjs) - Compiler from Go to JavaScript.|
...
|3|0|25|* [c4go](https://github.com/Konstantin8105/c4go) - Transpile C code to Go code.|
## Goroutines
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|1951|162|23|* [goworker](https://github.com/benmanns/goworker) - goworker is a Go-based background worker.|
|770|63|2|* [tunny](https://github.com/Jeffail/tunny) - Goroutine pool for golang.|
...
|15|3|0|* [workerpool](https://github.com/gammazero/workerpool) - Goroutine pool that limits the concurrency of task execution, not the number of tasks queued.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|5216|363|67|* [ui](https://github.com/andlabs/ui) - Platform-native GUI library for Go. Cross platform.|
|3943|266|91|* [qt](https://github.com/therecipe/qt) - Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi).|
|2853|235|26|* [robotgo](https://github.com/go-vgo/robotgo) - Go Native cross-platform GUI system automation. Control the mouse, keyboard and other.|
|2597|420|140|* [walk](https://github.com/lxn/walk) - Windows application library kit for Go.|
|2159|74|6|* [app](https://github.com/murlokswarm/app) - Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress.|
|1815|105|72|* [webview](https://github.com/zserge/webview) - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).|
|1541|78|8|* [go-astilectron](https://github.com/asticode/go-astilectron) - Build cross platform GUI apps with GO and HTML/JS/CSS (powered by Electron).|
|978|116|22|* [go-sciter](https://github.com/sciter-sdk/go-sciter) - Go bindings for Sciter: the Embeddable HTML/CSS/script engine for modern desktop UI development. Cross platform.|
|424|29|5|* [gosx-notifier](https://github.com/deckarep/gosx-notifier) - OSX Desktop Notifications library for Go.|
|414|78|24|* [gotk3](https://github.com/gotk3/gotk3) - Go bindings for GTK3.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|2196|65|8|* [ln](https://github.com/fogleman/ln) - 3D line art rendering in Go.|
|1801|174|6|* [resize](https://github.com/nfnt/resize) - Image resizing for Go with common interpolation methods.|
|1744|173|36|* [imaginary](https://github.com/h2non/imaginary) - Fast and simple HTTP microservice for image resizing.|
|1725|75|7|* [bild](https://github.com/anthonynsimon/bild) - Collection of image processing algorithms in pure Go.|
|1584|159|0|* [imaging](https://github.com/disintegration/imaging) - Simple Go image processing package.|
|1545|75|4|* [pt](https://github.com/fogleman/pt) - Path tracing engine written in Go.|
|1310|78|11|* [gg](https://github.com/fogleman/gg) - 2D rendering in pure Go.|
...
|941|115|30|* [gocv](https://github.com/hybridgroup/gocv) - Go package for computer vision using OpenCV 3.3+.|
|927|155|37|* [go-opencv](https://github.com/lazywei/go-opencv) - Go bindings for OpenCV.|
|833|75|17|* [picfit](https://github.com/thoas/picfit) - An image resizing server written in Go.|
|728|99|9|* [imagick](https://github.com/gographics/imagick) - Go binding to ImageMagick's MagickWand C API.|
|511|104|60|* [bimg](https://github.com/h2non/bimg) - Small package for fast and efficient image processing using libvips.|
|248|28|1|* [go-nude](https://github.com/koyachi/go-nude) - Nudity detection with Go.|
|236|7|6|* [govatar](https://github.com/o1egl/govatar) - Library and CMD tool for generating funny avatars.|
...
|69|19|2|* [go-cairo](https://github.com/ungerik/go-cairo) - Go binding for the cairo graphics library.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|661|158|41|* [gatt](https://github.com/paypal/gatt) - Gatt is a Go package for building Bluetooth Low Energy peripherals.|
|581|81|65|* [flogo](https://github.com/tibcosoftware/flogo) - Project Flogo is an Open Source Framework for IoT Edge Apps & Integration.|
|464|94|15|* [mainflux](https://github.com/Mainflux/mainflux) - Industrial IoT Messaging and Device Management Server.|
|201|14|9|* [devices](https://github.com/goiot/devices) - Suite of libraries for IoT devices, experimental for x/exp/io.|
|139|23|38|* [sensorbee](https://github.com/sensorbee/sensorbee) - Lightweight stream processing engine for IoT.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|7337|957|162|* [logrus](https://github.com/Sirupsen/logrus) - Structured logger for Go.|
|3848|258|19|* [zap](https://github.com/uber-go/zap) - Fast, structured, leveled logging in Go.|
|2321|148|18|* [spew](https://github.com/davecgh/go-spew) - Implements a deep pretty printer for Go data structures to aid in debugging.|
|1791|384|2|* [glog](https://github.com/golang/glog) - Leveled execution logs for Go.|
|1114|191|33|* [seelog](https://github.com/cihub/seelog) - Logging functionality with flexible dispatching, filtering, and formatting.|
|1075|53|7|* [zerolog](https://github.com/rs/zerolog) - Zero-allocation JSON logger.|
|1055|240|41|* [tail](https://github.com/hpcloud/tail) - Go package striving to emulate the features of the BSD tail program.|
|821|115|14|* [lumberjack](https://github.com/natefinch/lumberjack) - Simple rolling logger, implements io.WriteCloser.|
|733|88|40|* [log15](https://github.com/inconshreveable/log15) - Simple, powerful logging for Go.|
|539|54|17|* [log](https://github.com/apex/log) - Structured logging package for Go.|
...
|179|24|4|* [go-logger](https://github.com/apsdehal/go-logger) - Simple logger of Go Programs, with level handlers.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|5549|696|50|* [GoLearn](https://github.com/sjwhitworth/golearn) - General Machine Learning library for Go.|
|1874|179|37|* [gorgonia](https://github.com/chewxy/gorgonia) - graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms.|
|866|68|5|* [goml](https://github.com/cdipaolo/goml) - On-line Machine Learning in Go.|
|774|41|0|* [tfgo](https://github.com/galeone/tfgo) - Easy to use Tensorflow bindings: simplifies the usage of the official Tensorflow Go bindings. Define computational graphs in Go, load and execute models trained in Python.|
|588|71|33|* [CloudForest](https://github.com/ryanbressler/CloudForest) - Fast, flexible, multi-threaded ensembles of decision trees for machine learning in pure Go.|
|545|86|9|* [bayesian](https://github.com/jbrukh/bayesian) - Naive Bayesian Classification for Golang.|
|495|68|6|* [gosseract](https://github.com/otiai10/gosseract) - Go package for OCR (Optical Character Recognition), by using Tesseract C++ library.|
|479|30|0|* [gago](https://github.com/MaxHalford/gago) - Multi-population, flexible, parallel genetic algorithm.|
...
|113|9|0|* [goRecommend](https://github.com/timkaye11/goRecommend) - Recommendation Algorithms library written in Go.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|2866|538|39|* [sarama](https://github.com/Shopify/sarama) - Go library for Apache Kafka.|
|2624|215|10|* [Centrifugo](https://github.com/centrifugal/centrifugo) - Real-time messaging (Websockets or SockJS) server in Go.|
|2566|246|20|* [gorush](https://github.com/appleboy/gorush) - Push notification server using [APNs2](https://github.com/sideshow/apns2) and google [GCM](https://github.com/google/go-gcm).|
|2175|264|24|* [machinery](https://github.com/RichardKnop/machinery) - Asynchronous task queue/job queue based on distributed message passing.|
|2163|343|75|* [go-socket.io](https://github.com/googollee/go-socket.io) - socket.io library for golang, a realtime application framework.|
|1681|500|4|* [gopush-cluster](https://github.com/Terry-Mao/gopush-cluster) - gopush-cluster is a go push server cluster.|
|1641|223|9|* [NATS Go Client](https://github.com/nats-io/nats) - Lightweight and high performance publish-subscribe and distributed queueing messaging system - this is the Go library.|
|1373|127|24|* [mangos](https://github.com/go-mangos/mangos) - Pure go implementation of the Nanomsg ("Scalable Protocols") with transport interoperability.|
|1056|225|13|* [go-nsq](https://github.com/nsqio/go-nsq) - the official Go package for NSQ.|
|969|103|4|* [melody](https://github.com/olahol/melody) - Minimalist framework for dealing with websocket sessions, includes broadcasting and automatic ping/pong handling.|
...
|626|98|21|* [zmq4](https://github.com/pebbe/zmq4) - Go interface to ZeroMQ version 4. Also available for [version 3](https://github.com/pebbe/zmq3) and [version 2](https://github.com/pebbe/zmq2).|
...
|211|9|3|* [Benthos](https://github.com/Jeffail/benthos) - A message streaming bridge between a range of protocols.|
...
|190|28|3|* [pubsub](https://github.com/tuxychandru/pubsub) - Simple pubsub package for go.|
...
|28|7|2|* [nsq-event-bus](https://github.com/rafaeljesus/nsq-event-bus) - A tiny wrapper around NSQ topic and channel.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|2977|168|32|* [errors](https://github.com/pkg/errors) - Package that provides simple error handling primitives.|
|2608|524|64|* [gopsutil](https://github.com/shirou/gopsutil) - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).|
|1982|277|19|* [go.uuid](https://github.com/satori/go.uuid) - Implementation of Universally Unique Identifier (UUID). Supported both creation and parsing of UUIDs.|
|1121|98|7|* [gosms](https://github.com/haxpax/gosms) - Your own local SMS gateway in Go that can be used to send SMS.|
|862|89|27|* [archiver](https://github.com/mholt/archiver) - Library and command for making and extracting .zip and .tar.gz archives.|
...
|322|86|10|* [go-chat-bot](https://github.com/go-chat-bot/bot) - IRC, Slack & Telegram bot written in Go.|
|317|8|0|* [conv](https://github.com/cstockton/go-conv) - Package conv provides fast and intuitive conversions across Go types.|
|285|19|0|* [health](https://github.com/dimiro1/health) - Easy to use, extensible health check library.|
...
|177|23|4|* [slacker](https://github.com/shomali11/slacker) - Easy to use framework to create Slack bots.|
|161|9|0|* [banner](https://github.com/dimiro1/banner) - Add beautiful banners into your Go applications.|
|161|15|3|* [gountries](https://github.com/pariz/gountries) - Package that exposes country and subdivision data.|
|155|12|0|* [wuid](https://github.com/edwingeng/wuid) - An extremely fast unique number generator, 10-135 times faster than UUID.|
|111|9|0|* [gofakeit](https://github.com/brianvoe/gofakeit) - Random data generator written in go.|
...
|75|23|0|* [antch](https://github.com/antchfx/antch) - A fast, powerful and extensible web crawling & scraping framework.|
|49|6|0|* [hanu](https://github.com/sbstjn/hanu) - Framework for writing Slack bots.|
|49|6|2|* [bitio](https://github.com/icza/bitio) - Highly optimized bit-level Reader and Writer for Go.|
|48|4|0|* [lk](https://github.com/hyperboloide/lk) - A simple licensing library for golang.|
|46|7|0|* [margelet](https://github.com/zhulik/margelet) - Framework for building Telegram bots.|
...
|566|28|4|* [prose](https://github.com/jdkato/prose) - Library for text processing that supports tokenization, part-of-speech tagging, named-entity extraction, and more.|
...
|371|25|1|* [gse](https://github.com/go-ego/gse) - Go efficient text segmentation; support english, chinese, japanese and other.|
|329|20|4|* [nlp](https://github.com/Shixzie/nlp) - Extract values from strings and fill your structs with nlp.|
|275|16|2|* [whatlanggo](https://github.com/abadojack/whatlanggo) - Natural language detection package for Go. Supports 84 languages and 24 scripts (writing systems e.g. Latin, Cyrillic, etc).|
|232|16|3|* [sentences](https://github.com/neurosnap/sentences) - Sentence tokenizer:  converts text into a list of sentences.|
|129|13|0|* [nlp](https://github.com/james-bowman/nlp) - Go Natural Language Processing library supporting LSA (Latent Semantic Analysis).|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|7970|1623|95|* [kcptun](https://github.com/xtaci/kcptun) - Extremely simple & fast udp tunnel based on KCP protocol.|
|6188|550|158|* [fasthttp](https://github.com/valyala/fasthttp) - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.|
|2807|498|36|* [dns](https://github.com/miekg/dns) - Go library for working with DNS.|
|1890|361|62|* [gopacket](https://github.com/google/gopacket) - Go library for packet processing with libpcap bindings.|
|1283|230|52|* [gobgp](https://github.com/osrg/gobgp) - BGP implemented in the Go Programming Language.|
|1184|257|17|* [kcp-go](https://github.com/xtaci/kcp-go) - KCP - Fast and Reliable ARQ Protocol.|
|722|67|14|* [ssh](https://github.com/gliderlabs/ssh) - Higher-level API for building SSH servers (wraps crypto/ssh).|
|502|158|16|* [sftp](https://github.com/pkg/sftp) - Package sftp implements the SSH File Transfer Protocol as described in https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt.|
...
|428|37|25|* [NFF-Go](https://github.com/intel-go/nff-go) - Framework for rapid development of performant network functions for cloud and bare-metal (former YANFF).|
|413|81|31|* [mdns](https://github.com/hashicorp/mdns) - Simple mDNS (Multicast DNS) client/server library in Golang.|
|412|96|8|* [water](https://github.com/songgao/water) - Simple TUN/TAP library.|
|403|81|3|* [lhttp](https://github.com/fanux/lhttp) - Powerful websocket framework, build your IM server more easily.|
|341|139|14|* [ftp](https://github.com/jlaffaye/ftp) - Package ftp implements a FTP client as described in [RFC 959](http://tools.ietf.org/html/rfc959).|
|326|130|6|* [gotcp](https://github.com/gansidui/gotcp) - Go package for quickly writing tcp applications.|
|316|30|8|* [grab](https://github.com/cavaliercoder/grab) - Go package for managing file downloads.|
...
|296|24|54|* [fortio](https://github.com/istio/fortio) - Load testing library and command line tool and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them.|
|265|12|1|* [cidranger](https://github.com/yl2chen/cidranger) - Fast IP to CIDR lookup for Go.|
|259|8|1|* [peerdiscovery](https://github.com/schollz/peerdiscovery) - Pure Go library for cross-platform local peer discovery using UDP multicast|
|226|40|7|* [go-stun](https://github.com/ccding/go-stun) - Go implementation of the STUN client (RFC 3489 and RFC 5389).|
|200|26|5|* [raw](https://github.com/mdlayher/raw) - Package raw enables reading and writing data at the device driver level for a network interface.|
...
|154|50|11|* [winrm](https://github.com/masterzen/winrm) - Go WinRM client to remotely execute commands on Windows machines.|
...
|102|27|39|* [canopus](https://github.com/zubairhamed/canopus) - CoAP Client/Server implementation (RFC 7252).|
...
|89|11|1|* [stun](https://github.com/go-rtc/stun) - Go implementation of RFC 5389 STUN protocol.|
...
|38|7|1|* [xtcp](https://github.com/xfxdev/xtcp) - TCP Server Framework with simultaneous full duplex communication,graceful shutdown,custom protocol.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|475|60|6|* [glfw](https://github.com/go-gl/glfw) - Go bindings for GLFW 3.|
|471|36|7|* [gl](https://github.com/go-gl/gl) - Go bindings for OpenGL (generated via glow).|
|225|32|10|* [mathgl](https://github.com/go-gl/mathgl) - Pure Go math package specialized for 3D math, with inspiration from GLM.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|8864|1042|116|* [GORM](https://github.com/jinzhu/gorm) - The fantastic ORM library for Golang, aims to be developer friendly.|
|3173|439|154|* [Xorm](https://github.com/go-xorm/xorm) - Simple and powerful ORM for Go.|
|2764|325|116|* [gorp](https://github.com/go-gorp/gorp) - Go Relational Persistence, ORM-ish library for Go.|
|1655|117|19|* [go-pg](https://github.com/go-pg/pg) - PostgreSQL ORM with focus on PostgreSQL specific features and performance.|
...
|640|28|51|* [reform](https://github.com/go-reform/reform) - Better ORM for Go, based on non-empty interfaces and code generation.|
|565|96|0|* [pop/soda](https://github.com/markbates/pop) - Database migration, creation, ORM, etc... for MySQL, PostgreSQL, and SQLite.|
|494|87|9|* [QBS](https://github.com/coocood/qbs) - Stands for Query By Struct. A Go ORM.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|8960|635|382|* [dep](https://github.com/golang/dep) - Go dependency tool.|
|6617|442|375|* [glide](https://github.com/Masterminds/glide) - Manage your golang vendor and vendored packages with ease. Inspired by tools like Maven, Bundler, and Pip.|
|5344|468|79|* [godep](https://github.com/tools/godep) - dependency tool for go, godep helps build packages reproducibly by fixing their dependencies.|
|3380|260|115|* [govendor](https://github.com/kardianos/govendor) - Go Package Manager. Go vendor tool that works with the standard vendor file.|
...
|1198|54|14|* [gpm](https://github.com/pote/gpm) - Barebones dependency manager for Go.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|2989|273|78|* [graphql-go](https://github.com/graphql-go/graphql) - Implementation of GraphQL for Go.|
|1461|137|61|* [graphql](https://github.com/neelance/graphql-go) - GraphQL server with a focus on ease of use.|
|146|17|2|* [jsonql](https://github.com/elgs/jsonql) - JSON query expression library in Golang.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|1288|82|35|* [go.rice](https://github.com/GeertJohan/go.rice) - go.rice is a Go package that makes working with resources such as html,js,css,images and templates very easy.|
|1278|73|13|* [statik](https://github.com/rakyll/statik) - Embeds static files into a Go executable.|
|863|26|6|* [packr](https://github.com/gobuffalo/packr) - The simple and easy way to embed static files into Go binaries.|
...
|879|65|10|* [stats](https://github.com/montanaflynn/stats) - Statistics package with common functions missing from the Golang standard library.|
|823|77|76|* [gonum/plot](https://github.com/gonum/plot) - gonum/plot provides an API for building and drawing plots in Go.|
|521|45|6|* [go-dsp](https://github.com/mjibson/go-dsp) - Digital Signal Processing for Go.|
|481|66|3|* [goraph](https://github.com/gyuho/goraph) - Pure Go graph theory library(data structure, algorith visualization).|
|480|76|4|* [chart](https://github.com/vdobler/chart) - Simple Chart Plotting library for Go. Supports many graphs types.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|2546|305|111|* [lego](https://github.com/xenolf/lego) - Pure Go ACME client library and CLI tool (for use with Let's Encrypt).|
...
|764|22|1|* [memguard](https://github.com/awnumar/memguard) - A pure Go library for handling sensitive values in memory.|
...
|78|28|2|* [go-yara](https://github.com/hillu/go-yara) - Go Bindings for [YARA](https://github.com/plusvic/yara), the "pattern matching swiss knife for malware researchers (and everyone else)".|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|2880|663|55|* [goprotobuf](https://github.com/golang/protobuf) - Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers.|
|2760|234|11|* [jsoniter](https://github.com/json-iterator/go) - High-performance 100% compatible drop-in replacement of "encoding/json".|
|2150|183|21|* [structs](https://github.com/fatih/structs) - Library with support for converting structs to maps, struct keys/values to slices, and more.|
|1652|229|52|* [gogoprotobuf](https://github.com/gogo/protobuf) - Protocol Buffers for Go with Gadgets.|
|1399|177|29|* [mapstructure](https://github.com/mitchellh/mapstructure) - Go library for decoding generic map values into native Go structures.|
|934|145|1|* [go-codec](https://github.com/ugorji/go) - High Performance, feature-Rich, idiomatic encode, decode and rpc library for msgpack, cbor and json, with runtime-based OR code-generation support.|
|363|28|10|* [colfer](https://github.com/pascaldekloe/colfer) - Code generation for the Colfer binary format.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|18252|3597|258|* [etcd](https://github.com/coreos/etcd) - Highly-available key value store for shared configuration and service discovery.|
|17080|1298|105|* [Caddy](https://github.com/mholt/caddy) - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.|
|11301|950|116|* [minio](https://github.com/minio/minio) - Minio is a distributed object storage server.|
|2535|110|10|* [devd](https://github.com/cortesi/devd) - Local webserver for developers.|
...
|363|16|9|* [jackal](https://github.com/ortuman/jackal) - An XMPP server written in Go.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|2330|186|30|* [gofpdf](https://github.com/jung-kurt/gofpdf) - PDF document generator with high level support for text, drawing and images.|
|1205|118|40|* [pongo2](https://github.com/flosch/pongo2) - Django-like template-engine for Go.|
|962|62|14|* [quicktemplate](https://github.com/valyala/quicktemplate) - Fast, powerful, yet easy to use template engine. Converts templates into Go code and then compiles it.|
|954|56|18|* [hero](https://github.com/shiyanhui/hero) - Hero is a handy, fast and powerful go template engine.|
|926|142|33|* [mustache](https://github.com/hoisie/mustache) - Go implementation of the Mustache template language.|
...
|459|29|21|* [jet](https://github.com/CloudyKit/jet) - Jet template engine.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|4946|494|116|    * [Testify](https://github.com/stretchr/testify) - Sacred extension to the standard go testing package.|
|2225|125|22|    * [go-fuzz](https://github.com/dvyukov/go-fuzz) - Randomized testing system.|
|1986|124|36|    * [chromedp](https://github.com/knq/chromedp) - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.|
|1340|164|38|    * [gomock](https://github.com/golang/mock) - Mocking framework for the Go programming language.|
|871|58|10|    * [httpexpect](https://github.com/gavv/httpexpect) - Concise, declarative, and easy to use end-to-end HTTP and REST API testing.|
...
|486|37|9|    * [goblin](https://github.com/franela/goblin) - Mocha like testing framework fo Go.|
|474|21|8|    * [gock](https://github.com/h2non/gock) - Versatile HTTP mocking made easy.|
|421|38|5|    * [gofuzz](https://github.com/google/gofuzz) - Library for populating go objects with random values.|
|382|43|14|    * [godog](https://github.com/DATA-DOG/godog) - Cucumber or Behat like BDD framework for Go.|
|233|36|19|    * [counterfeiter](https://github.com/maxbrunsfeld/counterfeiter) - Tool for generating self-contained mock objects.|
...
|161|11|6|    * [gofight](https://github.com/appleboy/gofight) - API Handler Testing for Golang Router framework.|
|131|6|18|    * [go-mutesting](https://github.com/zimmski/go-mutesting) - Mutation testing for Go source code.|
...
|121|8|11|    * [cdp](https://github.com/mafredri/cdp) - Type-safe bindings for the Chrome Debugging Protocol that can be used with browsers or other debug targets that implement it.|
|109|17|4|    * [GoSpec](https://github.com/orfjackal/gospec) - BDD-style testing framework for the Go programming language.|
|50|5|3|    * [go-txdb](https://github.com/DATA-DOG/go-txdb) - Single transaction based database driver mainly for testing purposes.|
...
|36|5|1|    * [wstest](https://github.com/posener/wstest) - Websocket client for unit-testing a websocket http.Handler.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|5672|504|4|    * [GoQuery](https://github.com/PuerkitoBio/goquery) - GoQuery brings a syntax and a set of features similar to jQuery to the Go language.|
|4394|238|6|    * [colly](https://github.com/asciimoo/colly) - Fast and Elegant Scraping Framework for Gophers|
|3020|388|119|    * [blackfriday](https://github.com/russross/blackfriday) - Markdown processor in Go.|
|2005|250|39|    * [toml](https://github.com/BurntSushi/toml) - TOML configuration format (encoder/decoder with reflection).|
|1446|103|12|    * [go-humanize](https://github.com/dustin/go-humanize) - Formatters for time, numbers, and memory size to human readable format.|
|1068|44|11|    * [sh](https://github.com/mvdan/sh) - Shell parser and formatter.|
|905|60|5|    * [bluemonday](https://github.com/microcosm-cc/bluemonday) - HTML Sanitizer.|
...
|486|31|0|    * [commonregex](https://github.com/mingrammer/commonregex) - A collection of common regular expressions for Go|
|344|26|0|    * [xurls](https://github.com/mvdan/xurls) - Extract urls from text.|
|251|56|1|    * [mxj](https://github.com/clbanning/mxj) - Encode / decode XML as JSON or map[string]interface{}; extract values with dot-notation paths and wildcards. Replaces x2j and j2x packages.|
|192|25|0|    * [slug](https://github.com/gosimple/slug) - URL-friendly slugify with multiple languages support.|
|179|30|9|    * [gographviz](https://github.com/awalterschulze/gographviz) - Parses the Graphviz DOT language.|
...
|45|12|0|    * [go-nmea](https://github.com/adrianmo/go-nmea) - NMEA parser library for the Go language.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|3955|916|99|* [aws-sdk-go](https://github.com/aws/aws-sdk-go) - The official AWS SDK for the Go programming language.|
|3545|835|69|* [github](https://github.com/google/go-github) - Go library for accessing the GitHub REST API v3.|
|1582|343|44|* [slack](https://github.com/nlopes/slack) - Slack API in Go.|
|1378|363|46|* [google](https://github.com/google/google-api-go-client) - Auto-generated Google APIs for Go.|
|1073|341|79|* [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) - Google Cloud APIs Go Client Library.|
|1027|174|21|* [telegram-bot-api](https://github.com/Syfaro/telegram-bot-api) - Simple and clean Telegram bot client.|
|881|224|55|* [anaconda](https://github.com/ChimeraCoder/anaconda) - Go client library for the Twitter 1.1 API.|
|686|182|14|* [stripe](https://github.com/stripe/stripe-go) - Go client for the Stripe API.|
...
|629|92|10|* [telebot](https://github.com/tucnak/telebot) - Telegram bot framework written in Go.|
|628|194|2|* [facebook](https://github.com/huandu/facebook) - Go Library that supports the Facebook Graph API.|
|568|134|47|* [discordgo](https://github.com/bwmarrin/discordgo) - Go bindings for the Discord Chat API.|
|467|156|2|* [minio-go](https://github.com/minio/minio-go) - Minio Go Library for Amazon S3 compatible cloud storage.|
|446|88|22|* [go-twitter](https://github.com/dghubble/go-twitter) - Go client library for the Twitter v1.1 APIs.|
|255|115|7|* [go-jira](https://github.com/andygrunwald/go-jira) - Go client library for [Atlassian JIRA](https://www.atlassian.com/software/jira)|
...
|233|5|7|* [githubql](https://github.com/shurcooL/githubql) - Go library for accessing the GitHub GraphQL API v4.|
...
|74|29|5|* [ethrpc](https://github.com/onrik/ethrpc) - Go bindings for Ethereum JSON RPC API.|
...
|28|12|5|* [amazon-product-advertising-api](https://github.com/ngs/go-amazon-product-advertising-api) - Go Client Library for [Amazon Product Advertising API](https://affiliate-program.amazon.com/gp/advertising/api/detail/main.html).|
...
|23|19|2|* [circleci](https://github.com/jszwedko/go-circleci) - Go client library for interacting with CircleCI's API.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|14368|579|82|* [fzf](https://github.com/junegunn/fzf) - Command-line fuzzy finder written in Go.|
|12772|1265|222|* [hub](https://github.com/github/hub) - wrap git commands with additional functionality to interact with github from the terminal.|
|8171|636|107|* [delve](https://github.com/derekparker/delve) - Go debugger.|
|7375|248|24|* [wuzz](https://github.com/asciimoo/wuzz) - Interactive cli tool for HTTP inspection.|
|6946|238|23|* [ctop](https://github.com/bcicen/ctop) - [Top-like](http://ctop.sh) interface (e.g. htop) for container metrics.|
|4562|146|16|* [peco](https://github.com/peco/peco) - Simplistic interactive filtering tool.|
|4308|371|118|* [sqlx](https://github.com/jmoiron/sqlx) - provides a set of extensions on top of the excellent built-in database/sql package.|
|3539|341|2|* [godropbox](https://github.com/dropbox/godropbox) - Common libraries for writing Go services/applications from Dropbox.|
|2875|144|8|* [go-torch](https://github.com/uber/go-torch) - Stochastic flame graph profiler for Go programs.|
|2821|165|1|* [GJSON](https://github.com/tidwall/gjson) - Get a JSON value with one line of code.|
|2778|144|24|* [goreleaser](https://github.com/goreleaser/goreleaser) - Deliver Go binaries as fast and easily as possible.|
|2385|78|8|* [usql](https://github.com/knq/usql) - usql is a universal command-line interface for SQL databases.|
|2374|455|79|* [xlsx](https://github.com/tealeg/xlsx) - Library to simplify reading the XML format used by recent version of Microsoft Excel in Go programs.|
|2203|100|13|* [realize](https://github.com/tockins/realize) - Go build system with file watchers and live reload. Run, build and watch file changes with custom paths.|
|2037|209|87|* [excelize](https://github.com/360EntSecGroup-Skylar/excelize) - Golang library for reading and writing Microsoft Excel™ (XLSX) files.|
|2014|136|12|* [goreporter](https://github.com/wgliang/goreporter) - Golang tool that does static analysis, unit testing, code review and generate code quality report.|
|1667|227|62|* [gorequest](https://github.com/parnurzeal/gorequest) - Simplified HTTP client with rich features for Go.|
|1664|108|32|* [gojson](https://github.com/ChimeraCoder/gojson) - Automatically generate Go (golang) struct definitions from example JSON.|
|1658|51|6|* [panicparse](https://github.com/maruel/panicparse) - Groups similar goroutines and colorizes stack dump.|
|1424|83|12|* [minify](https://github.com/tdewolff/minify) - Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats.|
...
|1056|132|30|* [hystrix-go](https://github.com/afex/hystrix-go) - Implements Hystrix patterns of programmer-defined fallbacks aka circuit breaker.|
|1054|53|19|* [grequests](https://github.com/levigross/grequests) - Elegant and simple `net/http` wrapper that follows Python's requests library.|
|956|52|34|* [Storm](https://github.com/asdine/storm) - Simple and powerful toolkit for BoltDB.|
|954|49|3|* [go-underscore](https://github.com/tobyhede/go-underscore) - Useful collection of helpfully functional Go collection utilities.|
|869|99|3|* [resty](https://github.com/go-resty/resty) - Simple HTTP and REST client for Go inspired by Ruby rest-client.|
|861|25|12|* [Task](https://github.com/go-task/task) - simple "Make" alternative.|
|743|45|3|* [profile](https://github.com/pkg/profile) - Simple profiling support package for Go.|
|737|118|13|* [mc](https://github.com/minio/mc) - Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems.|
|690|51|36|* [boilr](https://github.com/tmrts/boilr) - Blazingly fast CLI tool for creating projects from boilerplate templates.|
...
|616|58|14|* [circuitbreaker](https://github.com/rubyist/circuitbreaker) - Circuit Breakers in Go.|
|536|27|29|* [git-time-metric](https://github.com/git-time-metric/gtm) - Simple, seamless, lightweight time tracking for Git.|
|526|21|9|* [gentleman](https://github.com/h2non/gentleman) - Full-featured plugin-driven HTTP client library.|
|508|34|5|* [spinner](https://github.com/briandowns/spinner) - Go package to easily provide a terminal spinner with options.|
...
|473|96|7|* [mergo](https://github.com/imdario/mergo) - Helper to merge structs and maps in Golang. Useful for configuration default values, avoiding messy if-statements.|
...
|400|28|0|* [go-dry](https://github.com/ungerik/go-dry) - DRY (don't repeat yourself) package for Go.|
|383|22|9|* [go-funk](https://github.com/thoas/go-funk) - Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...).|
|357|33|5|* [godaemon](https://github.com/VividCortex/godaemon) - Utility to write daemons.|
|288|24|5|* [request](https://github.com/mozillazg/request) - Go HTTP Requests for Humans™.|
|288|32|7|* [filetype](https://github.com/h2non/filetype) - Small package to infer the file type checking the magic numbers signature.|
|255|17|1|* [go-rate](https://github.com/beefsack/go-rate) - Timed rate limiter for Go.|
|249|27|1|* [pester](https://github.com/sethgrid/pester) - Go HTTP client calls with retries, backoff, and concurrency.|
|235|45|0|* [gohper](https://github.com/cosiner/gohper) - Various tools/modules help for development.|
...
|158|9|0|* [go-cron](https://github.com/rk/go-cron) - Simple Cron library for go that can execute closures or functions at varying intervals, from once a second to once a year on a specific date and time. Primarily for web applications and long running daemons.|
...
|109|7|0|* [gojq](https://github.com/elgs/gojq) - JSON query in Golang.|
|106|24|7|* [apm](https://github.com/topfreegames/apm) - Process manager for Golang applications with an HTTP API.|
...
|86|10|1|* [gotenv](https://github.com/subosito/gotenv) - Load environment variables from `.env` or any `io.Reader` in Go.|
...
|69|20|4|* [go-sitemap-generator](https://github.com/ikeikeikeike/go-sitemap-generator) - XML Sitemap generator written in Go.|
...
|60|9|0|* [util](https://github.com/shomali11/util) - Collection of useful utility functions. (strings, concurrency, manipulations, ...).|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|2592|263|54|* [govalidator](https://github.com/asaskevich/govalidator) - Validators and sanitizers for strings, numerics, slices and structs.|
|1749|132|17|* [validator](https://github.com/go-playground/validator) - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.|
|647|34|1|* [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) - Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags.|
|385|25|5|* [govalidator](https://github.com/thedevsaddam/govalidator) - Validate Golang request data with simple rules. Highly inspired by Laravel's request validation.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|458|94|21|* [goav](https://github.com/giorgisio/goav) - Comphrensive Go bindings for FFmpeg.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|17131|2008|213|* [Gin](https://github.com/gin-gonic/gin) - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.|
|15219|3318|491|* [Beego](https://github.com/astaxie/beego) - beego is an open-source, high-performance web framework for the Go programming language.|
|10285|897|116|* [Echo](https://github.com/labstack/echo) - High performance, minimalist Go web framework.|
|9800|1240|66|* [Revel](https://github.com/revel/revel) - High-productivity web framework for the Go language.|
|3103|332|42|* [go-json-rest](https://github.com/ant0ine/go-json-rest) - Quick and easy way to setup a RESTful JSON API.|
|2771|275|33|* [goa](https://github.com/raphael/goa) - Framework for developing microservices based on the design of Ruby's Praxis.|
|2341|220|12|* [Macaron](https://github.com/go-macaron/macaron) - Macaron is a high productive and modular design web framework in Go.|
|2200|136|7|* [Gizmo](https://github.com/NYTimes/gizmo) - Microservice toolkit used by the New York Times.|
|2035|134|6|* [utron](https://github.com/gernest/utron) - Lightweight MVC framework for Go(Golang).|
...
|360|36|6|* [neo](https://github.com/ivpusic/neo) - Neo is minimal and fast Go Web Framework with extremely simple API.|
...
|152|34|0|* [Gem](https://github.com/go-gem/gem) - Simple and fast web framework, friendly to REST API.|
...
|66|5|0|* [Air](https://github.com/sheng/air) - Ideal RESTful web framework for Go.|
...
|774|72|1|* [CORS](https://github.com/rs/cors) - Easily add CORS capabilities to your API.|
...
|1080|89|1|* [render](https://github.com/unrolled/render) - Go package for easily rendering JSON, XML, and HTML template responses.|
|475|35|7|* [stats](https://github.com/thoas/stats) - Go middleware that stores various information about your web application.|
|282|16|1|* [interpose](https://github.com/carbocation/interpose) - Minimalist net/http middleware for golang.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|6950|696|52|* [httprouter](https://github.com/julienschmidt/httprouter) - High performance router. Use this and the standard http handlers to form a very high performance web framework.|
|6070|751|25|* [mux](https://github.com/gorilla/mux) - Powerful URL router and dispatcher for golang.|
|3459|243|17|* [chi](https://github.com/go-chi/chi) - Small, fast and expressive HTTP router built on net/context.|
|1309|101|17|* [gocraft/web](https://github.com/gocraft/web) - Mux and middleware package in Go.|
...
|636|43|3|* [Goji](https://github.com/goji/goji) - Goji is a minimalistic and flexible HTTP request multiplexer with support for `net/context`.|
...
|354|18|1|* [lars](https://github.com/go-playground/lars) - Is a lightweight, fast and extensible zero allocation HTTP router for Go used to create customizable frameworks.|
|347|10|0|* [Siesta](https://github.com/VividCortex/siesta) - Composable framework to write middleware and handlers.|
|325|31|1|* [httptreemux](https://github.com/dimfeld/httptreemux) - High-speed, flexible tree-based HTTP router for Go. Inspiration from httprouter.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|2635|194|34|* [Go Metalinter](https://github.com/alecthomas/gometalinter) - Metalinter is a tool to automatically apply all static analysis tool and report their output in normalized form.|
|2516|317|61|* [GoLint](https://github.com/golang/lint) - Golint is a linter for Go source code.|
...
|698|14|0|* [interfacer](https://github.com/mvdan/interfacer) - Linter that suggests interface types.|
|333|12|5|* [php-parser](https://github.com/z7zmey/php-parser) - A Parser for PHP written in Go.|
...
|75|10|4|* [go-checkstyle](https://github.com/qiniu/checkstyle) - checkstyle is a style check tool like java checkstyle. This tool inspired by java checkstyle, golint. The style refered to some points in Go Code Review Comments.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|8451|861|57|* [vim-go](https://github.com/fatih/vim-go) - Go development plugin for Vim.|
|4261|486|63|* [gocode](https://github.com/nsf/gocode) - Autocompletion daemon for the Go programming language.|
|3485|375|160|* [vscode-go](https://github.com/Microsoft/vscode-go) - Extension for Visual Studio Code (VS Code) which provides support for the Go language.|
|2887|261|227|* [GoSublime](https://github.com/DisposaBoy/GoSublime) - Golang plugin collection for the text editor SublimeText 3 providing code completion and other IDE-like features.|
...
|760|134|52|* [go-mode](https://github.com/dominikh/go-mode.el) - Go mode for GNU/Emacs.|
|756|239|47|* [Goclipse](https://github.com/GoClipse/goclipse) - Eclipse plugin for Go.|
...
|619|44|23|* [genny](https://github.com/cheekybits/genny) - Elegant generics for Go.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|2707|198|35|* [OctoLinker](https://github.com/OctoLinker/browser-extension) - Navigate through go files efficiently with the OctoLinker browser extension for GitHub.|
|2236|411|237|* [go-swagger](https://github.com/go-swagger/go-swagger) - Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|48835|14307|3180|* [Moby](https://github.com/moby/moby) - Collaborative project for the container ecosystem to assemble container-based systems.|
|36136|12733|3324|* [kubernetes](https://github.com/kubernetes/kubernetes) - Container Cluster Manager from Google.|
|15068|1496|301|* [traefik](https://github.com/containous/traefik) - Reverse proxy and load balancer with support for multiple backends.|
|7772|483|50|* [Vegeta](https://github.com/tsenart/vegeta) - HTTP load testing tool and library. It's over 9000!|
|7630|2070|354|* [Packer](https://github.com/mitchellh/packer) - Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.|
|6542|691|797|* [Gitea](https://github.com/go-gitea/gitea) - Fork of Gogs, entirely community driven.|
|3519|234|134|* [GVM](https://github.com/moovweb/gvm) - GVM provides an interface to manage Go versions.|
|3253|247|42|* [Hey](https://github.com/rakyll/hey) - Hey is a tiny program that sends some load to a web application.|
|2855|227|34|* [webhook](https://github.com/adnanh/webhook) - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.|
|2650|192|36|* [gox](https://github.com/mitchellh/gox) - Dead simple, no frills Go cross compile tool.|
|2526|420|375|* [bosun](https://github.com/bosun-monitor/bosun) - Time Series Alerting Framework.|
|1906|336|50|* [Go Metrics](https://github.com/rcrowley/go-metrics) - Go port of Coda Hale's Metrics library: https://github.com/codahale/metrics.|
|1545|200|154|* [aptly](https://github.com/smira/aptly) - aptly is a Debian repository management tool.|
|1504|68|8|* [goxc](https://github.com/laher/goxc) - build tool for Go, with a focus on cross-compiling and packaging.|
|1199|102|14|* [kala](https://github.com/ajvb/kala) - Simplistic, modern, and performant job scheduler.|
|990|53|3|* [bombardier](https://github.com/codesenberg/bombardier) - Fast cross-platform HTTP benchmarking tool.|
...
|581|60|8|* [go-selfupdate](https://github.com/sanbornm/go-selfupdate) - Enable your Go applications to self update.|
...
|391|26|2|* [skm](https://github.com/TimothyYe/skm) - SKM is a simple and powerful SSH Keys Manager, it helps you to manage your multiple SSH keys easily!|
...
|281|41|5|* [aurora](https://github.com/xuri/aurora) - Cross-platform web-based Beanstalkd queue server console.|
|247|48|9|* [Mora](https://github.com/emicklei/mora) - REST server for accessing MongoDB documents and meta data.|
|236|10|0|* [govvv](https://github.com/ahmetalpbalkan/govvv) - “go build” wrapper to easily add version information into Go binaries.|
...
|154|17|2|* [manssh](https://github.com/xwjdsh/manssh) - manssh is a command line tool for managing your ssh alias config easily.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|8825|826|103|* [Gor](https://github.com/buger/gor) - Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time.|
|7951|762|461|* [rkt](https://github.com/coreos/rkt) - App Container runtime that integrates with init systems, is compatible with other container formats like Docker, and supports alternative execution engines like KVM.|
|5461|221|16|* [Comcast](https://github.com/tylertreat/Comcast) - Simulate bad network connections.|
|5331|723|52|* [Seaweed File System](https://github.com/chrislusf/seaweedfs) - Fast, Simple and Scalable Distributed File System with O(1) disk seek.|
|4989|850|58|* [confd](https://github.com/kelseyhightower/confd) - Manage local application configuration files using templates and data from etcd or consul.|
|4429|595|268|* [LiteIDE](https://github.com/visualfc/liteide) - LiteIDE is a simple, open source, cross-platform Go IDE.|
|4277|322|217|* [restic](https://github.com/restic/restic) - De-duplicating backup program.|
|3567|282|5|* [nes](https://github.com/fogleman/nes) - Nintendo Entertainment System (NES) emulator written in Go.|
|2718|151|34|* [toxiproxy](https://github.com/shopify/toxiproxy) - Proxy to simulate network and system conditions for automated tests.|
|2414|307|106|* [fleet](https://github.com/coreos/fleet) - Distributed init System.|
|2020|166|13|* [myLG](https://github.com/mehrdadrad/mylg) - Command Line Network Diagnostic tool written in Go.|
|1717|257|141|* [snap](https://github.com/intelsdi-x/snap) - Powerful telemetry framework.|
|1712|76|30|* [Stack Up](https://github.com/pressly/sup) - Stack Up, a super simple deployment tool - just Unix - think of it like 'make' for a network of servers.|
...
|1320|40|11|* [borg](https://github.com/crufter/borg) - Terminal based search engine for bash snippets.|
|892|142|4|* [Pipe](https://github.com/b3log/pipe) - A small and beautiful blogging platform.|
|847|28|11|* [Go Package Store](https://github.com/shurcooL/Go-Package-Store) - App that displays updates for the Go packages in your GOPATH.|
...
|415|44|12|* [Documize](https://github.com/documize/community) - Modern wiki software that integrates data from SaaS tools.|
...
|355|38|2|* [mockingjay](https://github.com/quii/mockingjay-server) - Fake HTTP servers and consumer driven contracts from one configuration file. You can also make the server randomly misbehave to help do more realistic performance tests.|
...
|203|38|1|* [GoDNS](https://github.com/timothyye/godns) - A dynamic DNS client tool, supports DNSPod & HE.net, written in Go.|
|172|8|0|* [ide](https://github.com/thestrukture/ide) - Browser accessible IDE. Designed for Go with Go.|
|169|14|19|* [gocc](https://github.com/goccmack/gocc) - Gocc is a compiler kit for Go written in Go.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|1064|135|25|* [go-http-routing-benchmark](https://github.com/julienschmidt/go-http-routing-benchmark) - Go HTTP request router benchmark and comparison.|
...
|640|63|4|* [go_serialization_benchmarks](https://github.com/alecthomas/go_serialization_benchmarks) - Benchmarks of Go serialization methods.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|4855|619|10|* [GoBooks](https://github.com/dariubs/GoBooks) - A curated list of Go books.|
## Gophers
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|1242|46|8|* [gophers](https://github.com/ashleymcnamara/gophers) - Gopher artworks by Ashley McNamara|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|21396|2766|3|* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) - List of other amazingly awesome lists.|
|11707|1146|6|* [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.|
