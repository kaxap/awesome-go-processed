...
| --- | --- | --- | --- |
|189|9|2|* [waveform](https://github.com/mdlayher/waveform) - Go package capable of generating waveform images from audio streams.|
|168|16|6|* [music-theory](https://github.com/go-music-theory/music-theory) - Music theory models in Go.|
|151|31|2|* [PortAudio](https://github.com/gordonklaus/portaudio) - Go bindings for the PortAudio audio I/O library.|
|139|39|11|* [portmidi](https://github.com/rakyll/portmidi) - Go bindings for PortMidi.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|9579|896|312|* [traefik](https://github.com/containous/traefik) - Reverse proxy and load balancer with support for multiple backends.|
|2498|273|37|* [jwt-go](https://github.com/dgrijalva/jwt-go) - Golang implementation of JSON Web Tokens (JWT).|
|1307|154|20|* [goth](https://github.com/markbates/goth) - provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple provides out of the box.|
|1243|318|40|* [oauth2](https://github.com/golang/oauth2) - Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine and App Engine support.|
|1223|248|31|* [osin](https://github.com/RangelReale/osin) - Golang OAuth2 server library.|
|1188|83|35|* [authboss](https://github.com/volatiletech/authboss) - Modular authentication system for the web. It tries to remove as much boilerplate and "hard things" as possible so that each time you start a new web project in Go, you can plug it in, configure, and start building your app without having to build an authentication system each time.|
|1151|125|4|* [casbin](https://github.com/hsluoyz/casbin) - Authorization library that supports access control models like ACL, RBAC, ABAC.|
|771|38|2|* [gologin](https://github.com/dghubble/gologin) - chainable handlers for login with OAuth1 and OAuth2 authentication providers.|
...
|623|71|5|* [go-oauth2-server](https://github.com/RichardKnop/go-oauth2-server) - Standalone, specification-compliant,  OAuth2 server written in Golang.|
|597|100|1|* [gorbac](https://github.com/mikespook/gorbac) - provides a lightweight role-based access control (RBAC) implementation in Golang.|
|444|26|11|* [loginsrv](https://github.com/tarent/loginsrv) - JWT login microservice with plugable backends such as OAuth2 (Github), htpasswd, osiam.|
...
|76|6|0|* [jwt-auth](https://github.com/adam-hanna/jwt-auth) - JWT middleware for goLang http servers with many configuration options.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|6429|593|77|* [urfave/cli](https://github.com/urfave/cli) - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).|
|5074|422|76|* [cobra](https://github.com/spf13/cobra) - Commander for modern Go CLI interactions.|
|3462|276|167|* [drive](https://github.com/odeke-em/drive) - Google Drive client for the commandline.|
|1436|97|11|* [kingpin](https://github.com/alecthomas/kingpin) - Command line and flag parser supporting sub commands.|
|874|117|14|* [go-flags](https://github.com/jessevdk/go-flags) - go command line option parser.|
...
|854|69|23|* [docopt.go](https://github.com/docopt/docopt.go) - Command-line arguments parser that will make you smile.|
|736|63|18|* [cli-init](https://github.com/tcnksm/gcli) - The easy way to start building Golang command line application.|
|663|53|9|* [mitchellh/cli](https://github.com/mitchellh/cli) - Go library for implementing command-line interfaces.|
|426|20|1|* [go-arg](https://github.com/alexflint/go-arg) - Struct-based argument parsing in Go.|
...
|300|25|13|* [cli](https://github.com/mkideal/cli) - Feature-rich and easy to use command-line package based on golang tag.|
|239|86|11|* [pflag](https://github.com/spf13/pflag) - Drop-in replacement for Go's flag package, implementing POSIX/GNU-style --flags.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|6401|353|69|* [termui](https://github.com/gizak/termui) - Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib).|
|2341|206|38|* [termbox-go](https://github.com/nsf/termbox-go) - Termbox is a library for creating cross-platform text-based interfaces.|
|1884|120|7|* [gocui](https://github.com/jroimartin/gocui) - Minimalist Go library aimed at creating Console User Interfaces.|
|1802|139|3|* [color](https://github.com/fatih/color) - Versatile package for colored terminal output.|
...
|566|23|10|* [uilive](https://github.com/gosuri/uilive) - Library for updating terminal output in realtime.|
|388|13|2|* [uitable](https://github.com/gosuri/uitable) - Library to improve readability in terminal apps using tabular data.|
...
|172|20|0|* [go-isatty](https://github.com/mattn/go-isatty) - isatty for golang.|
...
|95|9|1|* [mpb](https://github.com/vbauerster/mpb) - Multi progress bar for terminal applications.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|3592|371|143|* [viper](https://github.com/spf13/viper) - Go configuration with fangs.|
|664|45|10|* [godotenv](https://github.com/joho/godotenv) - Go port of Ruby's dotenv library (Loads environment variables from `.env`).|
|656|123|9|* [ini](https://github.com/go-ini/ini) - Go package for read and write INI files.|
|305|28|2|* [env](https://github.com/caarlos0/env) - Parse environment variables to Go structs (with defaults).|
...
|81|6|0|* [envcfg](https://github.com/tomazk/envcfg) - Un-marshaling environment variables to Go structs.|
...
|44|9|3|* [goConfig](https://github.com/crgimenes/goConfig) - Parse a struct as input and populates the fields of this struct with parameters fom command line, environment variables and configuration file.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|10929|1232|112|* [drone](https://github.com/drone/drone) - Drone is a Continuous Integration platform built on Docker, written in Go.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|3391|334|9|* [go-datastructures](https://github.com/Workiva/go-datastructures) - Collection of useful, performant, and thread-safe data structures.|
|3119|270|9|* [gods](https://github.com/emirpasic/gods) - Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.|
...
|594|74|4|* [golang-set](https://github.com/deckarep/golang-set) - Thread-Safe and Non-Thread-Safe high-performance sets for Go.|
...
|352|64|2|* [willf/bloom](https://github.com/willf/bloom) - Go package implementing Bloom filters.|
|312|36|10|* [gota](https://github.com/kniren/gota) - Implementation of dataframes, series, and data wrangling methods for Go.|
|303|61|0|* [bitset](https://github.com/willf/bitset) - Go package implementing bitsets.|
|275|33|21|* [roaring](https://github.com/RoaringBitmap/roaring) - Go package implementing compressed bitsets.|
...
|95|11|2|* [hilbert](https://github.com/google/hilbert) - Go package for mapping values to and from space-filling curves, such as Hilbert and Peano curves.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|11408|1292|231|* [prometheus](https://github.com/prometheus/prometheus) - Monitoring system and time series database.|
|11405|1632|560|* [influxdb](https://github.com/influxdb/influxdb) - Scalable datastore for metrics, events, and real-time analytics.|
|10983|1099|1048|* [cockroach](https://github.com/cockroachdb/cockroach) - Scalable, Geo-Replicated, Transactional Datastore.|
|9407|1295|337|* [tidb](https://github.com/pingcap/tidb) - TiDB is a distributed SQL database. Inspired by the design of Google F1.|
|6808|555|107|* [bolt](https://github.com/boltdb/bolt) - Low-level key/value database for Go.|
|5716|664|10|* [groupcache](https://github.com/golang/groupcache) - Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases.|
|4940|645|103|* [vitess](https://github.com/youtube/vitess) - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.|
|4469|289|24|* [pgweb](https://github.com/sosedoff/pgweb) - Web-based PostgreSQL database browser.|
|3695|190|66|* [dgraph](https://github.com/dgraph-io/dgraph) - Scalable, Distributed, Low Latency, High Throughput Graph Database.|
|3342|156|42|* [Tile38](https://github.com/tidwall/tile38) - Geolocation DB with spatial index and realtime geofencing.|
|3143|154|30|* [rqlite](https://github.com/rqlite/rqlite) - The lightweight, distributed, relational database built on SQLite.|
|2885|591|46|* [kingshard](https://github.com/flike/kingshard) - kingshard is a high performance proxy for MySQL powered by Golang.|
|2227|263|83|* [ledisdb](https://github.com/siddontang/ledisdb) - Ledisdb is a high performance NoSQL like Redis based on LevelDB.|
|1896|169|14|* [tiedot](https://github.com/HouzuoGuo/tiedot) - Your NoSQL database powered by Golang.|
|1741|224|24|* [goleveldb](https://github.com/syndtr/goleveldb) - Implementation of the [LevelDB](https://github.com/google/leveldb) key/value database in the Go.|
|1565|97|2|* [buntdb](https://github.com/tidwall/buntdb) - Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support.|
|1531|252|42|* [migrate](https://github.com/mattes/migrate) - Database migrations. CLI and Golang library.|
|1410|45|22|* [pREST](https://github.com/nuveo/prest) - Serve a RESTful API from any PostgreSQL database.|
|1246|102|41|* [xo](https://github.com/knq/xo) - Generate idiomatic Go code for databases based on existing schema definitions or custom queries supporting PostgreSQL, MySQL, SQLite, Oracle, and Microsoft SQL Server.|
|1198|97|32|* [Squirrel](https://github.com/Masterminds/squirrel) - Go library that helps you build SQL queries.|
|1064|196|27|* [go-cache](https://github.com/pmylund/go-cache) - In-memory key:value store/cache (similar to Memcached) library for Go, suitable for single-machine applications.|
|1050|73|3|* [BigCache](https://github.com/allegro/bigcache) - Efficient key/value cache for gigabytes of data.|
|858|203|52|* [go-mysql-elasticsearch](https://github.com/siddontang/go-mysql-elasticsearch) - Sync your MySQL data into Elasticsearch automatically.|
|840|113|62|* [orchestrator](https://github.com/github/orchestrator) - MySQL replication topology manager & visualizer.|
|744|78|31|* [sql-migrate](https://github.com/rubenv/sql-migrate) - Database migration tool. Allows embedding migrations into the application using go-bindata.|
|635|167|20|* [go-mysql](https://github.com/siddontang/go-mysql) - Go toolset to handle MySQL protocol and replication.|
|475|47|2|* [diskv](https://github.com/peterbourgon/diskv) - Home-grown disk-backed key-value store.|
|458|37|25|* [dat](https://github.com/mgutz/dat) - Go Postgres Data Access Toolkit.|
...
|349|23|36|* [moss](https://github.com/couchbase/moss) - Moss is a simple LSM key-value storage engine written in 100% Go.|
|335|32|9|* [goqu](https://github.com/doug-martin/goqu) - Idiomatic SQL builder and query library.|
...
|308|19|2|* [Dotsql](https://github.com/gchaincl/dotsql) - Go library that helps you keep sql files in one place and use it with ease.|
|306|63|3|* [levigo](https://github.com/jmhodges/levigo) - Levigo is a Go wrapper for LevelDB.|
|236|31|7|* [GCache](https://github.com/bluele/gcache) - Cache library with support for expirable Cache, LFU, LRU and ARC.|
|175|24|5|* [ozzo-dbx](https://github.com/go-ozzo/ozzo-dbx) - Powerful data retrieval methods as well as DB-agnostic query building capabilities.|
...
|71|19|5|* [Scribble](https://github.com/nanobox-io/golang-scribble) - Tiny flat file JSON store.|
|69|2|0|* [geocache](https://github.com/melihmucuk/geocache) - In-memory cache that is suitable for geolocation based applications.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|10430|899|65|    * [cayley](https://github.com/google/cayley) - Graph database with support for multiple backends.|
|4083|884|62|    * [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) - MySQL driver for Go.|
|3480|583|7|    * [redigo](https://github.com/garyburd/redigo) - Redigo is a Go client for the Redis database.|
|3464|298|93|    * [bleve](https://github.com/blevesearch/bleve) - Modern text indexing library for go.|
|3137|427|122|    * [pq](https://github.com/lib/pq) - Pure Go Postgres driver for database/sql.|
|2204|346|17|    * [redis](https://github.com/go-redis/redis) - Redis client for Golang.|
|1967|451|68|    * [go-sqlite3](https://github.com/mattn/go-sqlite3) - SQLite3 driver for go that using database/sql.|
|1634|379|24|    * [elastic](https://github.com/olivere/elastic) - Elasticsearch client for Go.|
...
|591|121|51|    * [go-mssqldb](https://github.com/denisenkom/go-mssqldb) - Microsoft MSSQL driver for Go.|
...
|230|93|9|    * [aerospike-client-go](https://github.com/aerospike/aerospike-client-go) - Aerospike client in Go language.|
|229|131|52|    * [go-oci8](https://github.com/mattn/go-oci8) - Oracle driver for go that using database/sql.|
...
|27|2|0|* [go-persian-calendar](https://github.com/yaa110/go-persian-calendar) - The implementation of the Persian (Solar Hijri) Calendar in Go (golang).|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|7607|754|33|* [go-kit](https://github.com/go-kit/kit) - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.|
|3840|712|100|* [grpc-go](https://github.com/grpc/grpc-go) - The Go language implementation of gRPC. HTTP/2 based RPC.|
|3509|256|1|* [micro](https://github.com/micro/micro) - Pluggable microservice toolkit and distributed systems platform.|
|3337|360|48|* [NATS](https://github.com/nats-io/gnatsd) - Lightweight, high performance messaging system for microservices, IoT, and cloud native systems.|
|1785|181|20|* [torrent](https://github.com/anacrolix/torrent) - BitTorrent client package.|
|1718|147|9|* [glow](https://github.com/chrislusf/glow) - Easy-to-Use scalable distributed big data processing, Map-Reduce, DAG execution, all in pure Go.|
|1392|245|11|* [rpcx](https://github.com/smallnest/rpcx) - Distributed pluggable RPC service framework like alibaba Dubbo.|
|1316|167|56|* [raft](https://github.com/hashicorp/raft) - Golang implementation of the Raft consensus protocol, by HashiCorp.|
|852|87|5|* [gleam](https://github.com/chrislusf/gleam) - Fast and scalable distributed map/reduce system written in pure Go and Luajit, combining Go's high concurrency with Luajit's high performance, runs standalone or distributed.|
|675|128|100|* [tendermint](https://github.com/tendermint/tendermint) - High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols.|
|618|123|7|* [hprose](https://github.com/hprose/hprose-golang) - Very newbility RPC Library, support 25+ languages now.|
|390|51|11|* [gorpc](https://github.com/valyala/gorpc) - Simple, fast and scalable RPC library for high load.|
|362|30|23|* [ringpop-go](https://github.com/uber/ringpop-go) - Scalable, fault-tolerant application-layer sharding for Go applications.|
...
|132|8|9|* [digota](https://github.com/digota/digota) - grpc ecommerce microservice.|
|127|11|0|* [go-jump](https://github.com/dgryski/go-jump) - Port of Google's "Jump" Consistent Hash function.|
|96|16|2|* [KrakenD](https://github.com/devopsfaith/krakend) - Ultra performant API Gateway framework with middlewares.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|2419|150|55|* [MailHog](https://github.com/mailhog/MailHog) - Email and SMTP testing with web and API interface.|
|970|33|4|* [hermes](https://github.com/matcornic/hermes) - Golang package that generates clean, responsive HTML e-mails.|
|791|90|24|* [email](https://github.com/jordan-wright/email) - A robust and flexible email library for Go.|
|270|29|17|* [go-imap](https://github.com/emersion/go-imap) - IMAP library for clients and servers.|
...
|26|6|3|* [go-message](https://github.com/emersion/go-message) - Streaming library for the Internet Message Format and mail messages.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|3152|268|65|* [otto](https://github.com/robertkrimen/otto) - JavaScript interpreter written in Go.|
|1774|159|13|* [gopher-lua](https://github.com/yuin/gopher-lua) - Lua 5.1 VM and compiler written in Go.|
|1045|62|26|* [go-lua](https://github.com/Shopify/go-lua) - Port of the Lua 5.2 VM to pure Go.|
|529|53|14|* [go-python](https://github.com/sbinet/go-python) - naive go bindings to the CPython C-API.|
...
|351|95|8|* [golua](https://github.com/aarzilli/golua) - Go bindings for Lua C API.|
|342|46|5|* [go-php](https://github.com/deuill/go-php) - PHP bindings for Go.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|1113|115|39|* [afero](https://github.com/spf13/afero) - FileSystem Abstraction System for Go.|
|264|36|23|* [notify](https://github.com/rjeczalik/notify) - File system event notification library with simple API, similar to os/signal.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|591|101|10|* [decimal](https://github.com/shopspring/decimal) - Arbitrary-precision fixed-point decimal numbers.|
|456|32|0|* [go-finance](https://github.com/FlashBoys/go-finance) - Comprehensive financial markets data in Go.|
|342|14|2|* [go-money](https://github.com/rhymond/go-money) - Implementation of Fowler's Money pattern.|
|308|14|1|* [accounting](https://github.com/leekchan/accounting) - money and currency formatting for golang.|
|35|1|3|* [vat](https://github.com/dannyvankooten/vat) - VAT number validation & EU VAT rates.|
|12|0|0|* [ofxgo](https://github.com/aclindsa/ofxgo) - Query OFX servers and/or parse the responses (with example command-line client).|
## Forms
...
|610|46|5|* [binding](https://github.com/mholt/binding) - Binds form and JSON data from net/http Request to struct.|
...
|88|8|1|* [conform](https://github.com/leebenson/conform) - Keeps user input in check. Trims, sanitizes & scrubs data based on struct tags.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|1513|455|5|* [Leaf](https://github.com/name5566/leaf) - Lightweight game server framework.|
|850|272|0|* [gonet](https://github.com/xtaci/gonet) - Game server skeleton implemented with golang.|
|786|47|6|* [termloop](https://github.com/JoelOtter/termloop) - Terminal-based game engine for Go, built on top of Termbox.|
|685|35|8|* [Pixel](https://github.com/faiface/pixel) - Hand-crafted 2D game library in Go.|
|654|95|7|* [go-sdl2](https://github.com/veandco/go-sdl2) - Go bindings for the [Simple DirectMedia Layer](https://www.libsdl.org/).|
...
|276|30|11|* [goworld](https://github.com/xiaonanln/goworld) - Scalable game server engine, featuring space-entity framework and hot-swapping|
|206|20|1|* [go-astar](https://github.com/beefsack/go-astar) - Go implementation of the A\* path finding algorithm.|
|205|14|0|* [nano](https://github.com/lonnng/nano) - Lightweight, facility, high performance golang based game server framework|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|1264|76|1|* [go-linq](https://github.com/ahmetalpbalkan/go-linq) - .NET LINQ-like query methods for Go.|
|825|60|29|* [gen](https://github.com/clipperhouse/gen) - Code generation tool for ‘generics’-like functionality.|
|508|19|0|* [jennifer](https://github.com/dave/jennifer) - Generate arbitrary Go code without templates.|
|412|11|16|* [goderive](https://github.com/awalterschulze/goderive) - Derives functions from input types.|
|112|4|0|* [interfaces](https://github.com/rjeczalik/interfaces) - Command line tool for generating interface definitions.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|5531|245|121|* [gopherjs](https://github.com/gopherjs/gopherjs) - Compiler from Go to JavaScript.|
...
|572|45|6|* [tunny](https://github.com/Jeffail/tunny) - Goroutine pool for golang.|
...
|75|1|0|* [go-floc](https://github.com/workanator/go-floc) - Orchestrate goroutines with ease.|
|51|6|0|* [go-flow](https://github.com/kamildrazkiewicz/go-flow) - Control goroutines execution order.|
|6|2|3|* [semaphore](https://github.com/kamilsk/semaphore) - Semaphore pattern implementation with timeout of lock/unlock operations based on channel and context.|
## GUI
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|4399|309|115|* [ui](https://github.com/andlabs/ui) - Platform-native GUI library for Go. Cross platform.|
|2869|173|119|* [qt](https://github.com/therecipe/qt) - Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi).|
|2090|154|12|* [robotgo](https://github.com/go-vgo/robotgo) - Go Native cross-platform GUI system automation;Control the mouse, keyboard and other.|
|2006|352|109|* [walk](https://github.com/lxn/walk) - Windows application library kit for Go.|
|1814|178|62|* [go-qml](https://github.com/go-qml/qml) - QML support for the Go language.|
|1782|51|8|* [app](https://github.com/murlokswarm/app) - Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress.|
|1297|102|36|* [goqt](https://github.com/visualfc/goqt) - Golang bindings to the Qt cross-platform application framework.|
|693|84|21|* [go-sciter](https://github.com/sciter-sdk/go-sciter) - Go bindings for Sciter: the Embeddable HTML/CSS/script engine for modern desktop UI development. Cross platform.|
|496|25|3|* [go-astilectron](https://github.com/asticode/go-astilectron) - Build cross platform GUI apps with GO and HTML/JS/CSS (powered by Electron).|
|385|27|4|* [gosx-notifier](https://github.com/deckarep/gosx-notifier) - OSX Desktop Notifications library for Go.|
|280|60|8|* [gotk3](https://github.com/gotk3/gotk3) - Go bindings for GTK3.|
|222|38|13|* [systray](https://github.com/getlantern/systray) - Cross platform Go library to place an icon and menu in the notification area.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|1974|57|6|* [ln](https://github.com/fogleman/ln) - 3D line art rendering in Go.|
|1528|64|6|* [bild](https://github.com/anthonynsimon/bild) - Collection of image processing algorithms in pure Go.|
|1514|144|12|* [resize](https://github.com/nfnt/resize) - Image resizing for the Go with common interpolation methods.|
|1452|68|4|* [pt](https://github.com/fogleman/pt) - Path tracing engine written in Go.|
|1310|124|24|* [imaginary](https://github.com/h2non/imaginary) - Fast and simple HTTP microservice for image resizing.|
|1258|138|0|* [imaging](https://github.com/disintegration/imaging) - Simple Go image processing package.|
|1031|66|6|* [gg](https://github.com/fogleman/gg) - 2D rendering in pure Go.|
|936|61|0|* [gift](https://github.com/disintegration/gift) - Package of image processing filters.|
|918|49|3|* [smartcrop](https://github.com/muesli/smartcrop) - Finds good crops for arbitrary images and crop sizes.|
...
|755|132|32|* [go-opencv](https://github.com/lazywei/go-opencv) - Go bindings for OpenCV.|
|670|65|16|* [picfit](https://github.com/thoas/picfit) - An image resizing server written in Go.|
|613|83|7|* [imagick](https://github.com/gographics/imagick) - Go binding to ImageMagick's MagickWand C API.|
...
|249|41|10|* [flogo](https://github.com/tibcosoftware/flogo) - Project Flogo is an Open Source Framework for IoT Edge Apps & Integration.|
|207|31|0|* [mainflux](https://github.com/Mainflux/mainflux) - Industrial IoT Messaging and Device Management Server.|
|189|14|9|* [devices](https://github.com/goiot/devices) - Suite of libraries for IoT devices, experimental for x/exp/io.|
|111|24|42|* [sensorbee](https://github.com/sensorbee/sensorbee) - Lightweight stream processing engine for IoT.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|5434|771|86|* [logrus](https://github.com/Sirupsen/logrus) - Structured logger for Go.|
|2749|173|12|* [zap](https://github.com/uber-go/zap) - Fast, structured, leveled logging in Go.|
|1555|101|13|* [spew](https://github.com/davecgh/go-spew) - Implements a deep pretty printer for Go data structures to aid in debugging.|
|1488|307|2|* [glog](https://github.com/golang/glog) - Leveled execution logs for Go.|
|957|172|24|* [seelog](https://github.com/cihub/seelog) - Logging functionality with flexible dispatching, filtering, and formatting.|
|819|191|30|* [tail](https://github.com/hpcloud/tail) - Go package striving to emulate the features of the BSD tail program.|
|622|80|40|* [log15](https://github.com/inconshreveable/log15) - Simple, powerful logging for Go.|
|569|83|6|* [lumberjack](https://github.com/natefinch/lumberjack) - Simple rolling logger, implements io.WriteCloser.|
|434|18|5|* [zerolog](https://github.com/rs/zerolog) - Zero-allocation JSON logger.|
|430|38|7|* [log](https://github.com/apex/log) - Structured logging package for Go.|
|298|30|20|* [logxi](https://github.com/mgutz/logxi) - 12-factor app logger that is fast and makes you happy.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|4453|521|45|* [GoLearn](https://github.com/sjwhitworth/golearn) - General Machine Learning library for Go.|
|1255|126|50|* [gorgonia](https://github.com/chewxy/gorgonia) - graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms.|
...
|204|28|4|* [gobrain](https://github.com/goml/gobrain) - Neural Networks written in go.|
...
|6|0|4|* [probab](https://github.com/ThePaw/probab) - Probability distribution functions. Bayesian inference. Written in pure Go.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|2098|405|26|* [sarama](https://github.com/Shopify/sarama) - Go library for Apache Kafka.|
|2056|161|6|* [Centrifugo](https://github.com/centrifugal/centrifugo) - Real-time messaging (Websockets or SockJS) server in Go.|
|1817|279|65|* [go-socket.io](https://github.com/googollee/go-socket.io) - socket.io library for golang, a realtime application framework.|
|1684|174|18|* [machinery](https://github.com/RichardKnop/machinery) - Asynchronous task queue/job queue based on distributed message passing.|
|1555|493|4|* [gopush-cluster](https://github.com/Terry-Mao/gopush-cluster) - gopush-cluster is a go push server cluster.|
|1303|182|7|* [NATS Go Client](https://github.com/nats-io/nats) - Lightweight and high performance publish-subscribe and distributed queueing messaging system - this is the Go library.|
|1241|137|16|* [gorush](https://github.com/appleboy/gorush) - Push notification server using [APNs2](https://github.com/sideshow/apns2) and google [GCM](https://github.com/google/go-gcm).|
|1193|103|22|* [mangos](https://github.com/go-mangos/mangos) - Pure go implementation of the Nanomsg ("Scalable Protocols") with transport interoperability.|
...
|859|198|11|* [go-nsq](https://github.com/nsqio/go-nsq) - the official Go package for NSQ.|
|681|74|3|* [melody](https://github.com/olahol/melody) - Minimalist framework for dealing with websocket sessions, includes broadcasting and automatic ping/pong handling.|
...
|287|32|4|* [EventBus](https://github.com/asaskevich/EventBus) - The lightweight event bus with async compatibility.|
...
|142|9|0|* [emitter](https://github.com/olebedev/emitter) - Emits events using Go way, with wildcard, predicates, cancellation possibilities and many other good wins.|
|141|22|1|* [pubsub](https://github.com/tuxychandru/pubsub) - Simple pubsub package for go.|
|104|11|5|* [guble](https://github.com/smancke/guble) - Messaging server using push notifications (Google Firebase Cloud Messaging, Apple Push Notification services, SMS) as well as websockets, a REST API, featuring distributed operation and message-persistence.|
...
|22|5|0|* [go-longpoll](https://github.com/ventu-io/go-longpoll) - PubSub with long polling.|
|16|6|2|* [nsq-event-bus](https://github.com/rafaeljesus/nsq-event-bus) - A tiny wrapper around NSQ topic and channel.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|2193|116|27|* [errors](https://github.com/pkg/errors) - Package that provides simple error handling primitives.|
|1892|426|49|* [gopsutil](https://github.com/shirou/gopsutil) - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).|
|1329|176|17|* [go.uuid](https://github.com/satori/go.uuid) - Implementation of Universally Unique Identifier (UUID). Supported both creation and parsing of UUIDs.|
|1039|88|3|* [gosms](https://github.com/haxpax/gosms) - Your own local SMS gateway in Go that can be used to send SMS.|
...
|388|56|2|* [go-commons-pool](https://github.com/jolestar/go-commons-pool) - Generic object pool for Golang.|
|329|22|6|* [go-multierror](https://github.com/hashicorp/go-multierror) - Go (golang) package for representing a list of errors as a single error.|
|303|6|1|* [conv](https://github.com/cstockton/go-conv) - Package conv provides fast and intuitive conversions across Go types.|
...
|73|10|1|* [stats](https://github.com/go-playground/stats) - Monitors Go MemStats + System stats such as Memory, Swap and CPU and sends via UDP anywhere you want for logging etc...|
...
|43|3|0|* [gofakeit](https://github.com/brianvoe/gofakeit) - Random data generator written in go.|
...
|283|10|0|* [nlp](https://github.com/Shixzie/nlp) - Extract values from strings and fill your structs with nlp.|
...
|198|7|2|* [prose](https://github.com/jdkato/prose) - Library for text processing that supports tokenization, part-of-speech tagging, named-entity extraction, and more.|
|68|11|0|* [go-nlp](https://github.com/nuance/go-nlp) - Utilities for working with discrete probability distributions and other tools useful for doing NLP work.|
|54|19|2|* [gounidecode](https://github.com/fiam/gounidecode) - Unicode transliterator (also known as unidecode) for Go.|
|54|4|0|* [nlp](https://github.com/james-bowman/nlp) - Go Natural Language Processing library supporting LSA (Latent Semantic Analysis).|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|6071|1220|50|* [kcptun](https://github.com/xtaci/kcptun) - Extremely simple & fast udp tunnel based on KCP protocol.|
|4876|438|122|* [fasthttp](https://github.com/valyala/fasthttp) - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.|
|2307|419|29|* [dns](https://github.com/miekg/dns) - Go library for working with DNS.|
|1427|281|41|* [gopacket](https://github.com/google/gopacket) - Go library for packet processing with libpcap bindings.|
|1032|175|30|* [gobgp](https://github.com/osrg/gobgp) - BGP implemented in the Go Programming Language.|
|774|163|7|* [kcp-go](https://github.com/xtaci/kcp-go) - KCP - Fast and Reliable ARQ Protocol.|
|473|34|12|* [ssh](https://github.com/gliderlabs/ssh) - Higher-level API for building SSH servers (wraps crypto/ssh).|
|390|122|11|* [sftp](https://github.com/pkg/sftp) - Package sftp implements the SSH File Transfer Protocol as described in https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt.|
|366|36|22|* [go-getter](https://github.com/hashicorp/go-getter) - Go library for downloading files or directories from various sources using a URL.|
...
|289|68|3|* [water](https://github.com/songgao/water) - Simple TUN/TAP library.|
|286|118|6|* [gotcp](https://github.com/gansidui/gotcp) - Go package for quickly writing tcp applications.|
|275|114|7|* [gopcap](https://github.com/akrennmair/gopcap) - Go wrapper for libpcap.|
|251|113|12|* [ftp](https://github.com/jlaffaye/ftp) - Package ftp implements a FTP client as described in [RFC 959](http://tools.ietf.org/html/rfc959).|
|220|65|18|* [gosnmp](https://github.com/soniah/gosnmp) - Native Go library for performing SNMP actions.|
|207|22|2|* [grab](https://github.com/cavaliercoder/grab) - Go package for managing file downloads.|
...
|141|55|1|* [tcp_server](https://github.com/firstrow/tcp_server) - Go library for building tcp servers faster.|
|129|42|8|* [winrm](https://github.com/masterzen/winrm) - Go WinRM client to remotely execute commands on Windows machines.|
...
|109|24|3|* [utp](https://github.com/anacrolix/utp) - Go uTP micro transport protocol implementation.|
|95|17|1|* [arp](https://github.com/mdlayher/arp) - Package arp implements the ARP protocol, as described in RFC 826.|
|91|11|10|* [sslb](https://github.com/eduardonunesp/sslb) - It's a Super Simples Load Balancer, just a little project to achieve some kind of performance.|
|84|20|35|* [canopus](https://github.com/zubairhamed/canopus) - CoAP Client/Server implementation (RFC 7252).|
...
|29|5|0|* [linkio](https://github.com/ian-kent/linkio) - Network link speed simulation for Reader/Writer interfaces.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|404|49|7|* [glfw](https://github.com/go-gl/glfw) - Go bindings for GLFW 3.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|6535|807|135|* [GORM](https://github.com/jinzhu/gorm) - The fantastic ORM library for Golang, aims to be developer friendly.|
|2552|306|104|* [gorp](https://github.com/go-gorp/gorp) - Go Relational Persistence, ORM-ish library for Go.|
|2266|340|100|* [Xorm](https://github.com/go-xorm/xorm) - Simple and powerful ORM for Go.|
|1090|70|11|* [go-pg](https://github.com/go-pg/pg) - PostgreSQL ORM with focus on PostgreSQL specific features and performance.|
|976|72|34|* [upper.io/db](https://github.com/upper/db) - Single interface for interacting with different data sources through the use of adapters that wrap mature database drivers.|
|754|64|32|* [SQLBoiler](https://github.com/volatiletech/sqlboiler) - ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema.|
|546|19|49|* [reform](https://github.com/go-reform/reform) - Better ORM for Go, based on non-empty interfaces and code generation.|
|460|88|9|* [QBS](https://github.com/coocood/qbs) - Stands for Query By Struct. A Go ORM.|
|271|43|32|* [pop/soda](https://github.com/markbates/pop) - Database migration, creation, ORM, etc... for MySQL, PostgreSQL, and SQLite.|
|169|10|3|* [Zoom](https://github.com/albrow/zoom) - Blazing-fast datastore and querying engine built on Redis.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|5275|344|321|* [glide](https://github.com/Masterminds/glide) - Manage your golang vendor and vendored packages with ease. Inspired by tools like Maven, Bundler, and Pip.|
|4883|429|108|* [godep](https://github.com/tools/godep) - dependency tool for go, godep helps build packages reproducibly by fixing their dependencies.|
|4537|273|223|* [dep](https://github.com/golang/dep) - Go dependency tool.|
|2386|202|94|* [govendor](https://github.com/kardianos/govendor) - Go Package Manager. Go vendor tool that works with the standard vendor file.|
|1508|129|42|* [gopm](https://github.com/gpmgo/gopm) - Go Package Manager.|
|1276|91|16|* [gom](https://github.com/mattn/gom) - Go Manager - bundle for go.|
|1159|53|10|* [gpm](https://github.com/pote/gpm) - Barebones dependency manager for Go.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|1858|183|54|* [graphql-go](https://github.com/graphql-go/graphql) - Implementation of GraphQL for Go.|
|700|56|16|* [graphql](https://github.com/neelance/graphql-go) - GraphQL server with a focus on ease of use.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|3109|243|65|* [go-bindata](https://github.com/jteeuwen/go-bindata) - Package that converts any file into managable Go source code.|
|1070|66|27|* [go.rice](https://github.com/GeertJohan/go.rice) - go.rice is a Go package that makes working with resources such as html,js,css,images and templates very easy.|
...
|179|12|4|* [vfsgen](https://github.com/shurcooL/vfsgen) - Generates a vfsdata.go file that statically implements the given virtual filesystem.|
...
|119|9|2|* [go-resources](https://github.com/omeid/go-resources) - Unfancy resources embedding with Go.|
...
|470|56|20|* [gonum/mat64](https://github.com/gonum/matrix) - The general purpose package for matrix computation. Package mat64 provides basic linear algebra operations for float64 matrices.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|2065|229|60|* [lego](https://github.com/xenolf/lego) - Pure Go ACME client library and CLI tool (for use with Let's Encrypt).|
|1308|65|58|* [acmetool](https://github.com/hlandau/acme) - ACME (Let's Encrypt) client tool with automatic renewal.|
|747|41|0|* [secure](https://github.com/unrolled/secure) - HTTP middleware for Go that facilitates some quick security wins.|
|613|12|1|* [memguard](https://github.com/awnumar/memguard) - A pure Go library for handling sensitive values in memory.|
...
|67|6|1|* [ssh-vault](https://github.com/ssh-vault/ssh-vault) - encrypt/decrypt using ssh keys.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|2071|500|102|* [goprotobuf](https://github.com/golang/protobuf) - Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers.|
|1279|104|5|* [jsoniter](https://github.com/json-iterator/go) - High-performance 100% compatible drop-in replacement of "encoding/json".|
|1146|158|52|* [gogoprotobuf](https://github.com/gogo/protobuf) - Protocol Buffers for Go with Gadgets.|
|1064|145|33|* [mapstructure](https://github.com/mitchellh/mapstructure) - Go library for decoding generic map values into native Go structures.|
|815|117|6|* [go-codec](https://github.com/ugorji/go) - High Performance, feature-Rich, idiomatic encode, decode and rpc library for msgpack, cbor and json, with runtime-based OR code-generation support.|
|265|21|8|* [colfer](https://github.com/pascaldekloe/colfer) - Code generation for the Colfer binary format.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|14745|2853|197|* [etcd](https://github.com/coreos/etcd) - Highly-available key value store for shared configuration and service discovery.|
|13834|946|85|* [Caddy](https://github.com/mholt/caddy) - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.|
|8179|638|155|* [minio](https://github.com/minio/minio) - Minio is a distributed object storage server.|
|2392|104|6|* [devd](https://github.com/cortesi/devd) - Local webserver for developers.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|1024|102|36|* [pongo2](https://github.com/flosch/pongo2) - Django-like template-engine for Go.|
|851|127|35|* [mustache](https://github.com/hoisie/mustache) - Go implementation of the Mustache template language.|
|793|48|10|* [quicktemplate](https://github.com/valyala/quicktemplate) - Fast, powerful, yet easy to use template engine. Converts templates into Go code and then compiles it.|
|792|39|14|* [hero](https://github.com/shiyanhui/hero) - Hero is a handy, fast and powerful go template engine.|
|744|44|17|* [amber](https://github.com/eknkc/amber) - Amber is an elegant templating engine for Go Programming Language It is inspired from HAML and Jade.|
|710|116|20|* [gofpdf](https://github.com/jung-kurt/gofpdf) - PDF document generator with high level support for text, drawing and images.|
...
|594|70|9|* [Razor](https://github.com/sipin/gorazor) - Razor view engine for Golang.|
...
|60|2|3|* [grender](https://github.com/dannyvankooten/grender) - small wrapper around html/template for file-based templates that support extending other template files.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|3666|392|104|    * [Testify](https://github.com/stretchr/testify) - Sacred extension to the standard go testing package.|
|1936|114|20|    * [go-fuzz](https://github.com/dvyukov/go-fuzz) - Randomized testing system.|
|1420|64|33|    * [chromedp](https://github.com/knq/chromedp) - Way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.|
|777|103|35|    * [gomock](https://github.com/golang/mock) - Mocking framework for the Go programming language.|
|750|43|7|    * [httpexpect](https://github.com/gavv/httpexpect) - Concise, declarative, and easy to use end-to-end HTTP and REST API testing.|
|546|76|3|    * [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) - Mock SQL driver for testing database interactions.|
|403|29|10|    * [goblin](https://github.com/franela/goblin) - Mocha like testing framework fo Go.|
|343|30|3|    * [gofuzz](https://github.com/google/gofuzz) - Library for populating go objects with random values.|
|339|12|4|    * [gock](https://github.com/h2non/gock) - Versatile HTTP mocking made easy.|
|277|10|7|    * [baloo](https://github.com/h2non/baloo) - Expressive and versatile end-to-end HTTP API testing made easy.|
|235|28|9|    * [godog](https://github.com/DATA-DOG/godog) - Cucumber or Behat like BDD framework for Go.|
...
|115|7|0|    * [testfixtures](https://github.com/go-testfixtures/testfixtures) - A helper for Rails' like test fixtures to test database applications.|
...
|104|5|2|    * [gofight](https://github.com/appleboy/gofight) - API Handler Testing for Golang Router framework.|
...
|39|4|5|    * [cdp](https://github.com/mafredri/cdp) - Type-safe bindings for the Chrome Debugging Protocol that can be used with browsers or other debug targets that implement it.|
|33|1|1|    * [go-txdb](https://github.com/DATA-DOG/go-txdb) - Single transaction based database driver mainly for testing purposes.|
...
|8|0|3|    * [cupaloy](https://github.com/bradleyjkemp/cupaloy) - Simple snapshot testing addon for your test framework.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|4548|414|6|    * [GoQuery](https://github.com/PuerkitoBio/goquery) - GoQuery brings a syntax and a set of features similar to jQuery to the Go language.|
|2588|329|87|    * [blackfriday](https://github.com/russross/blackfriday) - Markdown processor in Go.|
|1561|206|20|    * [toml](https://github.com/BurntSushi/toml) - TOML configuration format (encoder/decoder with reflection).|
|1104|94|14|    * [go-humanize](https://github.com/dustin/go-humanize) - Formatters for time, numbers, and memory size to human readable format.|
|717|45|2|    * [bluemonday](https://github.com/microcosm-cc/bluemonday) - HTML Sanitizer.|
|709|41|2|    * [inject](https://github.com/facebookgo/inject) - Package inject provides a reflect based injector.|
|703|30|11|    * [sh](https://github.com/mvdan/sh) - Shell parser and formatter.|
|667|46|14|    * [gofeed](https://github.com/mmcdole/gofeed) - Parse RSS and Atom feeds in Go.|
...
|199|44|0|    * [mxj](https://github.com/clbanning/mxj) - Encode / decode XML as JSON or map[string]interface{}; extract values with dot-notation paths and wildcards. Replaces x2j and j2x packages.|
...
|40|2|0|    * [goq](https://github.com/andrewstuart/goq) - Declarative unmarshaling of HTML using struct tags with jQuery syntax (uses GoQuery).|
...
|32|7|0|    * [go-nmea](https://github.com/adrianmo/go-nmea) - NMEA parser library for the Go language.|
...
|20|1|0|    * [allot](https://github.com/sbstjn/allot) - Placeholder and wildcard text parsing for CLI tools and bots.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|3399|716|61|* [aws-sdk-go](https://github.com/aws/aws-sdk-go) - The official AWS SDK for the Go programming language.|
|2858|674|45|* [github](https://github.com/google/go-github) - Go library for accessing the GitHub REST API v3.|
|1214|235|44|* [slack](https://github.com/nlopes/slack) - Slack API in Go.|
|1106|302|54|* [google](https://github.com/google/google-api-go-client) - Auto-generated Google APIs for Go.|
|823|242|95|* [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) - Google Cloud APIs Go Client Library.|
|760|186|53|* [anaconda](https://github.com/ChimeraCoder/anaconda) - Go client library for the Twitter 1.1 API.|
...
|647|110|15|* [telegram-bot-api](https://github.com/Syfaro/telegram-bot-api) - Simple and clean Telegram bot client.|
|593|156|5|* [stripe](https://github.com/stripe/stripe-go) - Go client for the Stripe API.|
|494|149|2|* [facebook](https://github.com/huandu/facebook) - Go Library that supports the Facebook Graph API.|
|369|99|38|* [discordgo](https://github.com/bwmarrin/discordgo) - Go bindings for the Discord Chat API.|
|357|112|17|* [minio-go](https://github.com/minio/minio-go) - Minio Go Library for Amazon S3 compatible cloud storage.|
...
|171|79|3|* [go-jira](https://github.com/andygrunwald/go-jira) - Go client library for [Atlassian JIRA](https://www.atlassian.com/software/jira)|
...
|79|14|1|* [Medium](https://github.com/Medium/medium-sdk-go) - Golang SDK for Medium's OAuth2 API.|
...
|35|4|0|* [cachet](https://github.com/andygrunwald/cachet) - Go client library for [Cachet (open source status page system)](https://cachethq.io/).|
...
|16|1|0|* [golyrics](https://github.com/mamal72/golyrics) - Golyrics is a Go library to fetch music lyrics data from the Wikia website.|
|14|8|5|* [circleci](https://github.com/jszwedko/go-circleci) - Go client library for interacting with CircleCI's API.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|11247|1042|182|* [hub](https://github.com/github/hub) - wrap git commands with additional functionality to interact with github from the terminal.|
|11164|1729|60|* [ngrok](https://github.com/inconshreveable/ngrok) - Introspected tunnels to localhost.|
|10037|394|42|* [fzf](https://github.com/junegunn/fzf) - Command-line fuzzy finder written in Go.|
|6752|229|28|* [wuzz](https://github.com/asciimoo/wuzz) - Interactive cli tool for HTTP inspection.|
|6297|452|90|* [delve](https://github.com/derekparker/delve) - Go debugger.|
|5985|190|24|* [ctop](https://github.com/bcicen/ctop) - [Top-like](http://ctop.sh) interface (e.g. htop) for container metrics.|
|4068|127|12|* [peco](https://github.com/peco/peco) - Simplistic interactive filtering tool.|
...
|3231|276|83|* [sqlx](https://github.com/jmoiron/sqlx) - provides a set of extensions on top of the excellent built-in database/sql package.|
|2191|101|6|* [go-torch](https://github.com/uber/go-torch) - Stochastic flame graph profiler for Go programs.|
|2056|71|2|* [usql](https://github.com/knq/usql) - usql is a universal command-line interface for SQL databases.|
|1878|389|59|* [xlsx](https://github.com/tealeg/xlsx) - Library to simplify reading the XML format used by recent version of Microsoft Excel in Go programs.|
|1705|65|25|* [goreleaser](https://github.com/goreleaser/goreleaser) - Deliver Go binaries as fast and easily as possible.|
|1672|98|4|* [goreporter](https://github.com/wgliang/goreporter) - Golang tool that does static analysis, unit testing, code review and generate code quality report.|
|1671|94|3|* [GJSON](https://github.com/tidwall/gjson) - Get a JSON value with one line of code.|
|1598|61|8|* [realize](https://github.com/tockins/realize) - Go build system with file watchers and live reload. Run, build and watch file changes with custom paths.|
...
|1397|118|42|* [excelize](https://github.com/Luxurioust/excelize) - Golang library for reading and writing Microsoft Excel (XLSX) files.|
|1289|165|48|* [gorequest](https://github.com/parnurzeal/gorequest) - Simplified HTTP client with rich features for Go.|
|1264|25|10|* [mmake](https://github.com/tj/mmake) - Modern Make.|
|1194|45|5|* [coop](https://github.com/rakyll/coop) - Cheat sheet for some of the common concurrent flows in Go.|
|1029|63|7|* [minify](https://github.com/tdewolff/minify) - Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats.|
|914|53|16|* [grequests](https://github.com/levigross/grequests) - Elegant and simple `net/http` wrapper that follows Python's requests library.|
|913|47|3|* [go-underscore](https://github.com/tobyhede/go-underscore) - Useful collection of helpfully functional Go collection utilities.|
...
|645|42|3|* [profile](https://github.com/pkg/profile) - Simple profiling support package for Go.|
|633|39|25|* [Storm](https://github.com/asdine/storm) - Simple and powerful toolkit for BoltDB.|
...
|558|83|30|* [mc](https://github.com/minio/mc) - Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems.|
|549|47|4|* [sling](https://github.com/dghubble/sling) - Go HTTP requests builder for API clients.|
|539|36|29|* [boilr](https://github.com/tmrts/boilr) - Blazingly fast CLI tool for creating projects from boilerplate templates.|
|490|40|9|* [circuitbreaker](https://github.com/rubyist/circuitbreaker) - Circuit Breakers in Go.|
|468|15|3|* [gron](https://github.com/roylee0704/gron) - Define time-based tasks using a simple Go API and Gron’s scheduler will run them accordingly.|
...
|368|11|8|* [Task](https://github.com/go-task/task) - simple "Make" alternative.|
|359|30|2|* [spinner](https://github.com/briandowns/spinner) - Go package to easily provide a terminal spinner with options.|
|319|28|3|* [godaemon](https://github.com/VividCortex/godaemon) - Utility to write daemons.|
|314|61|16|* [mergo](https://github.com/imdario/mergo) - Helper to merge structs and maps in Golang. Useful for configuration default values, avoiding messy if-statements.|
...
|193|20|5|* [pester](https://github.com/sethgrid/pester) - Go HTTP client calls with retries, backoff, and concurrency.|
...
|134|4|0|* [moldova](https://github.com/StabbyCutyou/moldova) - Utility for generating random data based on an input template.|
|128|7|0|* [rerun](https://github.com/ivpusic/rerun) - Recompiling and rerunning go apps when source changes.|
|119|6|1|* [robustly](https://github.com/VividCortex/robustly) - Runs functions resiliently, catching and restarting panics.|
...
|86|7|0|* [lrserver](https://github.com/jaschaephraim/lrserver) - LiveReload server for Go.|
|79|7|0|* [gojq](https://github.com/elgs/gojq) - JSON query in Golang.|
|72|1|1|* [jsongo](https://github.com/ricardolonga/jsongo) - Fluent API to make it easier to create Json objects.|
...
|55|3|1|* [onecache](https://github.com/adelowo/onecache) - Caching library with support for multiple backend stores (Redis, Memcached, filesystem etc).|
...
|26|3|0|* [go-astitodo](https://github.com/asticode/go-astitodo) - Parse TODOs in your GO code.|
|26|3|0|* [util](https://github.com/shomali11/util) - Collection of useful utility functions. (strings, concurrency, manipulations, ...).|
|26|0|25|* [retry](https://github.com/kamilsk/retry) - Functional mechanism based on context to perform actions repetitively until successful.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|2027|196|42|* [govalidator](https://github.com/asaskevich/govalidator) - Validators and sanitizers for strings, numerics, slices and structs.|
|1140|88|9|* [validator](https://github.com/go-playground/validator) - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.|
|419|22|0|* [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) - Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|1033|188|38|* [git2go](https://github.com/libgit2/git2go) - Go bindings for libgit2.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|349|69|15|* [goav](https://github.com/giorgisio/goav) - Comphrensive Go bindings for FFmpeg.|
|299|68|22|* [gmf](https://github.com/3d0c/gmf) - Go bindings for FFmpeg av\* libraries.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|12183|2806|315|* [Beego](https://github.com/astaxie/beego) - beego is an open-source, high-performance web framework for the Go programming language.|
|11589|1356|117|* [Gin](https://github.com/gin-gonic/gin) - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.|
|8739|1158|51|* [Revel](https://github.com/revel/revel) - High-productivity web framework for the Go language.|
|8162|714|84|* [Echo](https://github.com/labstack/echo) - High performance, minimalist Go web framework.|
|2886|314|33|* [go-json-rest](https://github.com/ant0ine/go-json-rest) - Quick and easy way to setup a RESTful JSON API.|
|2270|225|51|* [goa](https://github.com/raphael/goa) - Framework for developing microservices based on the design of Ruby's Praxis.|
|2020|185|12|* [Macaron](https://github.com/go-macaron/macaron) - Macaron is a high productive and modular design web framework in Go.|
|1916|111|5|* [utron](https://github.com/gernest/utron) - Lightweight MVC framework for Go(Golang).|
|1897|121|6|* [Gizmo](https://github.com/NYTimes/gizmo) - Microservice toolkit used by the New York Times.|
...
|619|91|9|* [tango](https://github.com/lunny/tango) - Micro & pluggable web framework for Go.|
|514|20|0|* [traffic](https://github.com/pilu/traffic) - Sinatra inspired regexp/pattern mux and web framework for Go.|
|380|10|0|* [gongular](https://github.com/mustafaakin/gongular) - Fast Go web framework with input mapping/validation and (DI) Dependency Injection.|
|318|30|3|* [neo](https://github.com/ivpusic/neo) - Neo is minimal and fast Go Web Framework with extremely simple API.|
|312|34|10|* [mango](https://github.com/paulbellamy/mango) - Mango is a modular web-application framework for Go, inspired by Rack, and PEP333.|
|307|20|8|* [Gondola](https://github.com/rainycape/gondola) - The web framework for writing faster sites, faster.|
|200|16|6|* [Golf](https://github.com/dinever/golf) - Golf is a fast, simple and lightweight micro-web framework for Go. It comes with powerful features and has no dependencies other than the Go Standard Library.|
|143|31|0|* [Gem](https://github.com/go-gem/gem) - Simple and fast web framework, friendly to REST API.|
...
|31|10|0|* [Florest](https://github.com/jabong/florest-core) - High-performance workflow based REST API framework.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|587|61|3|* [Tollbooth](https://github.com/didip/tollbooth) - Rate limit HTTP request handler.|
|567|49|2|* [CORS](https://github.com/rs/cors) - Easily add CORS capabilities to your API.|
|265|24|6|* [Limiter](https://github.com/ulule/limiter) - Dead simple rate limit middleware for Go.|
...
|1336|85|3|* [alice](https://github.com/justinas/alice) - Painless middleware chaining for Go.|
|937|80|0|* [render](https://github.com/unrolled/render) - Go package for easily rendering JSON, XML, and HTML template responses.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|5478|546|43|* [httprouter](https://github.com/julienschmidt/httprouter) - High performance router. Use this and the standard http handlers to form a very high performance web framework.|
|4429|599|24|* [mux](https://github.com/gorilla/mux) - Powerful URL router and dispatcher for golang.|
|2406|157|5|* [chi](https://github.com/go-chi/chi) - Small, fast and expressive HTTP router built on net/context.|
|1232|91|17|* [gocraft/web](https://github.com/gocraft/web) - Mux and middleware package in Go.|
|1063|103|6|* [pat](https://github.com/bmizerany/pat) - Sinatra style pattern muxer for Go’s net/http library, by the author of Sinatra.|
|1052|71|1|* [Bone](https://github.com/go-zoo/bone) - Lightning Fast HTTP Multiplexer.|
|518|32|4|* [Goji](https://github.com/goji/goji) - Goji is a minimalistic and flexible HTTP request multiplexer with support for `net/context`.|
|347|52|5|* [fasthttprouter](https://github.com/buaazp/fasthttprouter) - High performance router forked from `httprouter`. The first router fit for `fasthttp`.|
|342|11|5|* [Siesta](https://github.com/VividCortex/siesta) - Composable framework to write middleware and handlers.|
|331|19|1|* [lars](https://github.com/go-playground/lars) - Is a lightweight, fast and extensible zero allocation HTTP router for Go used to create customizable frameworks.|
|257|26|1|* [httptreemux](https://github.com/dimfeld/httptreemux) - High-speed, flexible tree-based HTTP router for Go. Inspiration from httprouter.|
|206|34|7|* [ozzo-routing](https://github.com/go-ozzo/ozzo-routing) - An extremely fast Go (golang) HTTP router that supports regular expression route matching. Comes with full support for building RESTful APIs.|
|173|22|11|* [vestigo](https://github.com/husobee/vestigo) - Performant, stand-alone, HTTP compliant URL Router for go web applications.|
...
|72|7|2|* [xmux](https://github.com/rs/xmux) - High performance muxer based on `httprouter` with `net/context` support.|
|37|4|0|* [pure](https://github.com/go-playground/pure) - Is a lightweight HTTP router that sticks to the std "net/http" implementation.|
...
|16|1|0|* [GoRouter](https://github.com/vardius/gorouter) - GoRouter is a Server/API micro framwework, HTTP request router, multiplexer, mux that provides request router with middleware supporting `net/context`.|
## Windows
...
|27|3|3|* [xpath](https://github.com/antchfx/xpath) - XPath package for Go.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|1972|241|74|* [GoLint](https://github.com/golang/lint) - Golint is a linter for Go source code.|
|1873|142|14|* [Go Metalinter](https://github.com/alecthomas/gometalinter) - Metalinter is a tool to automatically apply all static analysis tool and report their output in normalized form.|
|867|50|10|* [errcheck](https://github.com/kisielk/errcheck) - Errcheck is a program for checking for unchecked errors in Go programs.|
|718|49|8|* [gcvis](https://github.com/davecheney/gcvis) - Visualise Go program GC trace data in real time.|
...
|184|17|1|* [goast-viewer](https://github.com/yuroyoro/goast-viewer) - Web based Golang AST visualizer.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|7110|710|40|* [vim-go](https://github.com/fatih/vim-go) - Go development plugin for Vim.|
|3856|457|46|* [gocode](https://github.com/nsf/gocode) - Autocompletion daemon for the Go programming language.|
|2779|276|130|* [vscode-go](https://github.com/Microsoft/vscode-go) - Extension for Visual Studio Code (VS Code) which provides support for the Go language.|
|2684|242|215|* [GoSublime](https://github.com/DisposaBoy/GoSublime) - Golang plugin collection for the text editor SublimeText 2 providing code completion and other IDE-like features.|
...
|710|219|39|* [Goclipse](https://github.com/GoClipse/goclipse) - Eclipse plugin for Go.|
|640|118|36|* [go-mode](https://github.com/dominikh/go-mode.el) - Go mode for GNU/Emacs.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|2294|169|24|* [OctoLinker](https://github.com/OctoLinker/browser-extension) - Navigate through go files efficiently with the OctoLinker browser extension for GitHub.|
|1444|295|215|* [go-swagger](https://github.com/go-swagger/go-swagger) - Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API.|
|891|28|4|* [go-callvis](https://github.com/TrueFurby/go-callvis) - Visualize call graph of your Go program using dot format.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|45309|13475|2885|* [Moby](https://github.com/moby/moby) - Collaborative project for the container ecosystem to assemble container-based systems.|
|26580|9486|5306|* [kubernetes](https://github.com/kubernetes/kubernetes) - Container Cluster Manager from Google.|
|6826|1777|298|* [Packer](https://github.com/mitchellh/packer) - Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.|
|6234|367|38|* [Vegeta](https://github.com/tsenart/vegeta) - HTTP load testing tool and library. It's over 9000!|
|3505|376|509|* [Gitea](https://github.com/go-gitea/gitea) - Fork of Gogs, entirely community driven.|
|2995|193|117|* [GVM](https://github.com/moovweb/gvm) - GVM provides an interface to manage Go versions.|
|2344|390|349|* [bosun](https://github.com/bosun-monitor/bosun) - Time Series Alerting Framework.|
|2301|156|32|* [gox](https://github.com/mitchellh/gox) - Dead simple, no frills Go cross compile tool.|
|1986|156|26|* [Hey](https://github.com/rakyll/hey) - Hey is a tiny program that sends some load to a web application.|
|1919|141|11|* [webhook](https://github.com/adnanh/webhook) - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.|
|1664|297|53|* [Go Metrics](https://github.com/rcrowley/go-metrics) - Go port of Coda Hale's Metrics library: https://github.com/codahale/metrics.|
|1455|63|8|* [goxc](https://github.com/laher/goxc) - build tool for Go, with a focus on cross-compiling and packaging.|
|1399|179|152|* [aptly](https://github.com/smira/aptly) - aptly is a Debian repository management tool.|
|1060|79|17|* [kala](https://github.com/ajvb/kala) - Simplistic, modern, and performant job scheduler.|
...
|829|78|15|* [Banshee](https://github.com/eleme/banshee) - Anomalies detection system for periodic metrics.|
|801|70|11|* [StatusOK](https://github.com/sanathp/statusok) - Monitor your Website and REST APIs.Get Notified through Slack, E-mail when your server is down or response time is more than expected.|
|669|26|1|* [bombardier](https://github.com/codesenberg/bombardier) - Fast cross-platform HTTP benchmarking tool.|
...
|207|41|10|* [Mora](https://github.com/emicklei/mora) - REST server for accessing MongoDB documents and meta data.|
|206|31|0|* [aurora](https://github.com/Luxurioust/aurora) - Cross-platform web-based Beanstalkd queue server console.|
|174|7|2|* [govvv](https://github.com/ahmetalpbalkan/govvv) - “go build” wrapper to easily add version information into Go binaries.|
|166|16|4|* [gobrew](https://github.com/cryptojuice/gobrew) - gobrew lets you easily switch between multiple versions of go.|
...
|114|7|0|* [Pewpew](https://github.com/bengadbois/pewpew) - Flexible HTTP command line stress tester.|
...
|26|3|1|* [winrm-cli](https://github.com/masterzen/winrm-cli) - Cli tool to remotely execute commands on Windows machines.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|7801|700|63|* [Gor](https://github.com/buger/gor) - Http traffic replication tool, for replaying traffic from production to stage/dev environments in real-time.|
|7331|710|468|* [rkt](https://github.com/coreos/rkt) - App Container runtime that integrates with init systems, is compatible with other container formats like Docker, and supports alternative execution engines like KVM.|
|4955|196|16|* [Comcast](https://github.com/tylertreat/Comcast) - Simulate bad network connections.|
|4575|622|31|* [Seaweed File System](https://github.com/chrislusf/seaweedfs) - Fast, Simple and Scalable Distributed File System with O(1) disk seek.|
|4136|685|61|* [confd](https://github.com/kelseyhightower/confd) - Manage local application configuration files using templates and data from etcd or consul.|
|3915|533|240|* [LiteIDE](https://github.com/visualfc/liteide) - LiteIDE is a simple, open source, cross-platform Go IDE.|
|2812|242|2|* [nes](https://github.com/fogleman/nes) - Nintendo Entertainment System (NES) emulator written in Go.|
|2476|205|184|* [restic](https://github.com/restic/restic) - De-duplicating backup program.|
|2400|312|106|* [fleet](https://github.com/coreos/fleet) - Distributed init System.|
|2098|111|25|* [toxiproxy](https://github.com/shopify/toxiproxy) - Proxy to simulate network and system conditions for automated tests.|
|1839|134|11|* [myLG](https://github.com/mehrdadrad/mylg) - Command Line Network Diagnostic tool written in Go.|
|1569|232|132|* [snap](https://github.com/intelsdi-x/snap) - Powerful telemetry framework.|
|1553|137|8|* [Circuit](https://github.com/gocircuit/circuit) - Circuit is a programmable platform-as-a-service (PaaS) and/or Infrastructure-as-a-Service (IaaS), for management, discovery, synchronization and orchestration of services and hosts comprising cloud applications.|
|1516|58|28|* [Stack Up](https://github.com/pressly/sup) - Stack Up, a super simple deployment tool - just Unix - think of it like 'make' for a network of servers.|
|1275|36|10|* [borg](https://github.com/crufter/borg) - Terminal based search engine for bash snippets.|
|780|25|8|* [Go Package Store](https://github.com/shurcooL/Go-Package-Store) - App that displays updates for the Go packages in your GOPATH.|
|683|44|8|* [Postman](https://github.com/zachlatta/postman) - Command-line utility for batch-sending email.|
|511|34|11|* [Leaps](https://github.com/jeffail/leaps) - Pair programming service using Operational Transforms.|
...
|263|33|7|* [Documize](https://github.com/documize/community) - Modern wiki software that integrates data from SaaS tools.|
|249|15|17|* [wellington](https://github.com/wellington/wellington) - Sass project management tool, extends the language with sprite functions (like Compass).|
|243|31|5|* [vFlow](https://github.com/VerizonDigital/vflow) - High-performance, scalable and reliable IPFIX, sFlow and Netflow collector.|
...
|129|9|13|* [gocc](https://github.com/goccmack/gocc) - Gocc is a compiler kit for Go written in Go.|
|60|7|0|* [boxed](https://github.com/tejo/boxed) - Dropbox based blog engine.|
|47|1|0|* [Orbit](https://github.com/gulien/orbit) - A simple tool for running commands and generating files from templates.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|946|127|21|* [go-http-routing-benchmark](https://github.com/julienschmidt/go-http-routing-benchmark) - Go HTTP request router benchmark and comparison.|
...
|510|62|2|* [go-web-framework-benchmark](https://github.com/smallnest/go-web-framework-benchmark) - Go web framework benchmark.|
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|3872|460|2|* [GoBooks](https://github.com/dariubs/GoBooks) - A curated list of Go books.|
## Twitter
...
|stars|forks|issues|description|
| --- | --- | --- | --- |
|19564|2501|0|* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) - List of other amazingly awesome lists.|
|9806|910|8|* [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) - Curated list of awesome remote jobs. A lot of them is looking for Go hackers.|
