...
* **71** [flac](https://github.com/eaburns/flac) - Native Go FLAC decoder. ->  forks: 7, open issues:2_
* **51** [flac](https://github.com/mewkiz/flac) - Native Go FLAC decoder. ->  forks: 12, open issues:2_
* **30** [gaad](https://github.com/Comcast/gaad) - Native Go AAC bitstream parser. ->  forks: 2, open issues:1_
* **50** [go-sox](https://github.com/krig/go-sox) - libsox bindings for go. ->  forks: 8, open issues:5_
* **16** [go_mediainfo](https://github.com/zhulik/go_mediainfo) - libmediainfo bindings for go. ->  forks: 4, open issues:0_
* **3** [gosamplerate](https://github.com/dh1tw/gosamplerate) - libsamplerate bindings for go. ->  forks: 0, open issues:0_
* **48** [id3v2](https://github.com/bogem/id3v2) - Fast and stable ID3 parsing and writing library for Go. ->  forks: 7, open issues:2_
* **63** [mix](https://github.com/go-mix/mix) - Sequence-based Go-native audio mixer for music apps. ->  forks: 11, open issues:11_
* **59** [mp3](https://github.com/tcolgate/mp3) - Native Go MP3 decoder. ->  forks: 7, open issues:0_
* **168** [music-theory](https://github.com/go-music-theory/music-theory) - Music theory models in Go. ->  forks: 16, open issues:6_
* **149** [PortAudio](https://github.com/gordonklaus/portaudio) - Go bindings for the PortAudio audio I/O library. ->  forks: 31, open issues:2_
* **137** [portmidi](https://github.com/rakyll/portmidi) - Go bindings for PortMidi. ->  forks: 38, open issues:10_
* **52** [taglib](https://github.com/wtolson/go-taglib) - Go bindings for taglib. ->  forks: 16, open issues:3_
* **16** [vorbis](https://github.com/mccoyst/vorbis) - "Native" Go Vorbis decoder (uses CGO, but has no dependencies). ->  forks: 5, open issues:2_
* **189** [waveform](https://github.com/mdlayher/waveform) - Go package capable of generating waveform images from audio streams. ->  forks: 10, open issues:2_
...
* **1135** [casbin](https://github.com/hsluoyz/casbin) - Authorization library that supports access control models like ACL, RBAC, ABAC. ->  forks: 123, open issues:4_
* **174** [Go-AWS-Auth](https://github.com/smartystreets/go-aws-auth) - AWS (Amazon Web Services) request signing library. ->  forks: 38, open issues:17_
* **726** [go-jose](https://github.com/square/go-jose) - Fairly complete implementation of the JOSE working group's JSON Web Token, JSON Web Signatures, and JSON Web Encryption specs. ->  forks: 93, open issues:16_
* **616** [go-oauth2-server](https://github.com/RichardKnop/go-oauth2-server) - Standalone, specification-compliant,  OAuth2 server written in Golang. ->  forks: 71, open issues:5_
* **347** [go.auth](https://github.com/bradrydzewski/go.auth) - Authentication API for Go web applications. ->  forks: 30, open issues:9_
* **769** [gologin](https://github.com/dghubble/gologin) - chainable handlers for login with OAuth1 and OAuth2 authentication providers. ->  forks: 37, open issues:2_
* **596** [gorbac](https://github.com/mikespook/gorbac) - provides a lightweight role-based access control (RBAC) implementation in Golang. ->  forks: 100, open issues:1_
* **1305** [goth](https://github.com/markbates/goth) - provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple provides out of the box. ->  forks: 153, open issues:20_
* **120** [httpauth](https://github.com/goji/httpauth) - HTTP Authentication middleware. ->  forks: 16, open issues:1_
* **20** [jwt](https://github.com/robbert229/jwt) - Clean and easy to use implementation of JSON Web Tokens (JWT). ->  forks: 6, open issues:7_
* **75** [jwt-auth](https://github.com/adam-hanna/jwt-auth) - JWT middleware for goLang http servers with many configuration options. ->  forks: 6, open issues:0_
* **2491** [jwt-go](https://github.com/dgrijalva/jwt-go) - Golang implementation of JSON Web Tokens (JWT). ->  forks: 274, open issues:37_
* **442** [loginsrv](https://github.com/tarent/loginsrv) - JWT login microservice with plugable backends such as OAuth2 (Github), htpasswd, osiam. ->  forks: 25, open issues:11_
* **1242** [oauth2](https://github.com/golang/oauth2) - Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine and App Engine support. ->  forks: 318, open issues:40_
* **1219** [osin](https://github.com/RangelReale/osin) - Golang OAuth2 server library. ->  forks: 248, open issues:31_
* **237** [permissions2](https://github.com/xyproto/permissions2) - Library for keeping track of users, login states and permissions. Uses secure cookies and bcrypt. ->  forks: 13, open issues:2_
* **37** [session](https://github.com/icza/session) - Go session management for web servers (including support for Google App Engine - GAE). ->  forks: 3, open issues:3_
* **23** [sessions](https://github.com/adam-hanna/sessions) - Dead simple, highly performant, highly customizable sessions service for go http servers. ->  forks: 0, open issues:1_
* **9546** [traefik](https://github.com/containous/traefik) - Reverse proxy and load balancer with support for multiple backends. ->  forks: 890, open issues:303_
* **75** [yubigo](https://github.com/GeertJohan/yubigo) - Yubikey client package that provides a simple API to integrate the Yubico Yubikey into a go application. ->  forks: 10, open issues:3_
...
* **2** [argv](https://github.com/cosiner/argv) - Go library to split command line string as arguments array using the bash syntax. ->  forks: 0, open issues:0_
* **299** [cli](https://github.com/mkideal/cli) - Feature-rich and easy to use command-line package based on golang tag. ->  forks: 24, open issues:10_
* **735** [cli-init](https://github.com/tcnksm/gcli) - The easy way to start building Golang command line application. ->  forks: 63, open issues:18_
* [climax](http://github.com/tucnak/climax) - Alternative CLI with "human face", in spirit of Go command.
* **5062** [cobra](https://github.com/spf13/cobra) - Commander for modern Go CLI interactions. ->  forks: 419, open issues:77_
* **197** [complete](https://github.com/posener/complete) - Write bash completions in Go + Go command bash completion. ->  forks: 8, open issues:3_
* **852** [docopt.go](https://github.com/docopt/docopt.go) - Command-line arguments parser that will make you smile. ->  forks: 69, open issues:23_
* **3460** [drive](https://github.com/odeke-em/drive) - Google Drive client for the commandline. ->  forks: 275, open issues:167_
* **5** [env](https://github.com/codingconcepts/env) - Tag-based environment configuration for structs. ->  forks: 0, open issues:0_
* **70** [flag](https://github.com/cosiner/flag) - Simple but powerful command line option parsing library for Go support subcommand. ->  forks: 2, open issues:3_
* **425** [go-arg](https://github.com/alexflint/go-arg) - Struct-based argument parsing in Go. ->  forks: 19, open issues:1_
* **873** [go-flags](https://github.com/jessevdk/go-flags) - go command line option parser. ->  forks: 117, open issues:14_
* **1431** [kingpin](https://github.com/alecthomas/kingpin) - Command line and flag parser supporting sub commands. ->  forks: 97, open issues:11_
* **390** [liner](https://github.com/peterh/liner) - Go readline-like library for command-line interfaces. ->  forks: 63, open issues:2_
* **663** [mitchellh/cli](https://github.com/mitchellh/cli) - Go library for implementing command-line interfaces. ->  forks: 53, open issues:8_
* **423** [mow.cli](https://github.com/jawher/mow.cli) - Go library for building CLI applications with sophisticated flag and argument parsing and validation. ->  forks: 27, open issues:5_
* **238** [pflag](https://github.com/spf13/pflag) - Drop-in replacement for Go's flag package, implementing POSIX/GNU-style --flags. ->  forks: 85, open issues:11_
* **859** [readline](https://github.com/chzyer/readline) - Pure golang implementation that provide most of features in GNU-Readline under MIT license. ->  forks: 75, open issues:38_
* **44** [sflags](https://github.com/octago/sflags) - Struct based flags generator for flag, urfave/cli, pflag, cobra, kingpin and other libraries. ->  forks: 3, open issues:3_
* **77** [ukautz/clif](https://github.com/ukautz/clif) - Small command line interface framework. ->  forks: 8, open issues:5_
* **6414** [urfave/cli](https://github.com/urfave/cli) - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli). ->  forks: 593, open issues:77_
* **19** [wlog](https://github.com/dixonwille/wlog) - Simple logging interface that supports cross-platform color and concurrency. ->  forks: 2, open issues:0_
* **34** [wmenu](https://github.com/dixonwille/wmenu) - Easy to use menu structure for cli applications that prompts users to make choices. ->  forks: 4, open issues:1_

### Advanced Console UIs

*Libraries for building Console Applications and Console User Interfaces.*

* **243** [aurora](https://github.com/logrusorgru/aurora) - ANSI terminal colors that supports fmt.Printf/Sprintf. ->  forks: 7, open issues:0_
* **208** [chalk](https://github.com/ttacon/chalk) - Intuitive package for prettifying terminal/console output. ->  forks: 13, open issues:2_
* **1792** [color](https://github.com/fatih/color) - Versatile package for colored terminal output. ->  forks: 139, open issues:4_
* **11** [colourize](https://github.com/TreyBastian/colourize) - Go library for ANSI colour text in terminals. ->  forks: 2, open issues:0_
* **1** [go-ataman](https://github.com/workanator/go-ataman) - Go library for rendering ANSI colored text templates in terminals. ->  forks: 0, open issues:0_
* **200** [go-colorable](https://github.com/mattn/go-colorable) - Colorable writer for windows. ->  forks: 32, open issues:3_
* **160** [go-colortext](https://github.com/daviddengcn/go-colortext) - Go library for color output in terminals. ->  forks: 10, open issues:2_
* **171** [go-isatty](https://github.com/mattn/go-isatty) - isatty for golang. ->  forks: 20, open issues:0_
* **1880** [gocui](https://github.com/jroimartin/gocui) - Minimalist Go library aimed at creating Console User Interfaces. ->  forks: 120, open issues:7_
...
* **94** [mpb](https://github.com/vbauerster/mpb) - Multi progress bar for terminal applications. ->  forks: 9, open issues:1_
* **2340** [termbox-go](https://github.com/nsf/termbox-go) - Termbox is a library for creating cross-platform text-based interfaces. ->  forks: 206, open issues:38_
* **100** [termtables](https://github.com/apcera/termtables) - Go port of the Ruby library [terminal-tables](https://github.com/tj/terminal-table) for simple ASCII table generation as well as providing markdown and HTML output. ->  forks: 14, open issues:6_
* **6397** [termui](https://github.com/gizak/termui) - Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib). ->  forks: 353, open issues:69_
* **565** [uilive](https://github.com/gosuri/uilive) - Library for updating terminal output in realtime. ->  forks: 23, open issues:10_
* **983** [uiprogress](https://github.com/gosuri/uiprogress) - Flexible library to render progress bars in terminal applications. ->  forks: 47, open issues:10_
* **387** [uitable](https://github.com/gosuri/uitable) - Library to improve readability in terminal apps using tabular data. ->  forks: 13, open issues:2_

## Configuration

*Libraries for configuration parsing.*

* **123** [config](https://github.com/olebedev/config) - JSON or YAML configuration wrapper with environment variables and flags parsing. ->  forks: 23, open issues:2_
* **28** [configure](https://github.com/paked/configure) - Provides configuration through multiple sources, including JSON, flags and environment variables. ->  forks: 3, open issues:0_
* **303** [env](https://github.com/caarlos0/env) - Parse environment variables to Go structs (with defaults). ->  forks: 28, open issues:1_
* **81** [envcfg](https://github.com/tomazk/envcfg) - Un-marshaling environment variables to Go structs. ->  forks: 5, open issues:0_
* **5** [envconf](https://github.com/ian-kent/envconf) - Configuration from environment. ->  forks: 2, open issues:0_
* **108** [envconfig](https://github.com/vrischmann/envconfig) - Read your configuration from environment variables. ->  forks: 9, open issues:1_
* **66** [gcfg](https://github.com/go-gcfg/gcfg) - read INI-style configuration files into Go structs; supports user-defined types and subsections. ->  forks: 17, open issues:3_
* **43** [goConfig](https://github.com/crgimenes/goConfig) - Parse a struct as input and populates the fields of this struct with parameters fom command line, environment variables and configuration file. ->  forks: 9, open issues:3_
* **661** [godotenv](https://github.com/joho/godotenv) - Go port of Ruby's dotenv library (Loads environment variables from `.env`). ->  forks: 45, open issues:10_
* **43** [gofigure](https://github.com/ian-kent/gofigure) - Go application configuration made easy. ->  forks: 6, open issues:0_
...
* **93** [hjson](https://github.com/hjson/hjson-go) - Human JSON, a configuration file format for humans. Relaxed syntax, fewer mistakes, more comments. ->  forks: 9, open issues:0_
* **13** [ingo](https://github.com/schachmat/ingo) - Flags persisted in an ini-like config file. ->  forks: 1, open issues:0_
* **653** [ini](https://github.com/go-ini/ini) - Go package for read and write INI files. ->  forks: 123, open issues:9_
* **142** [joshbetz/config](https://github.com/joshbetz/config) - Small configuration library for Go that parses environment variables, JSON files, and reloads automatically on SIGHUP. ->  forks: 7, open issues:1_
* **12** [mini](https://github.com/sasbury/mini) - Golang package for parsing ini-style configuration files. ->  forks: 4, open issues:0_
* **207** [store](https://github.com/tucnak/store) - Lightweight configuration manager for Go. ->  forks: 8, open issues:0_
* **3586** [viper](https://github.com/spf13/viper) - Go configuration with fangs. ->  forks: 372, open issues:143_
* **0** [xdg](https://github.com/OpenPeeDeeP/xdg) - Cross platform package that follows the [XDG Standard](https://standards.freedesktop.org/basedir-spec/basedir-spec-latest.html). ->  forks: 0, open issues:0_

## Continuous Integration

*Tools for help with continuous integration.*

* **10905** [drone](https://github.com/drone/drone) - Drone is a Continuous Integration platform built on Docker, written in Go. ->  forks: 1232, open issues:109_
* **410** [goveralls](https://github.com/mattn/goveralls) - Go integration for Coveralls.io continuous code coverage tracking system. ->  forks: 65, open issues:9_
* **65** [overalls](https://github.com/go-playground/overalls) - Multi-Package go project coverprofile for tools like goveralls. ->  forks: 16, open issues:1_
* **1** [roveralls](https://github.com/LawrenceWoodman/roveralls) - Recursive coverage testing tool. ->  forks: 0, open issues:0_

## CSS Preprocessors

*Libraries for preprocessing CSS files.*

* **379** [c6](https://github.com/c9s/c6) - High performance SASS compatible-implementation compiler written in Go. ->  forks: 24, open issues:47_
* **384** [gcss](https://github.com/yosssi/gcss) - Pure Go CSS Preprocessor. ->  forks: 24, open issues:7_
* **60** [go-libsass](https://github.com/wellington/go-libsass) - Go wrapper to the 100% Sass compatible libsass project. ->  forks: 8, open issues:9_

## Data Structures

*Generic datastructures and algorithms in Go.*

* **50** [binpacker](https://github.com/zhuangsirui/binpacker) - Binary packer and unpacker helps user build custom binary stream. ->  forks: 11, open issues:0_
* **4** [bit](https://github.com/yourbasic/bit) - Golang set data structure with bonus bit-twiddling functions. ->  forks: 1, open issues:0_
* **303** [bitset](https://github.com/willf/bitset) - Go package implementing bitsets. ->  forks: 62, open issues:0_
* **103** [bloom](https://github.com/zhenjl/bloom) - Bloom filters implemented in Go. ->  forks: 10, open issues:0_
* **2** [bloom](https://github.com/yourbasic/bloom) - Golang Bloom filter implementation. ->  forks: 0, open issues:0_
* **845** [boomfilters](https://github.com/tylertreat/BoomFilters) - Probabilistic data structures for processing continuous, unbounded streams. ->  forks: 50, open issues:5_
* **32** [count-min-log](https://github.com/seiflotfy/count-min-log) - Go implementation Count-Min-Log sketch: Approximately counting with approximate counters (Like Count-Min sketch but using less memory). ->  forks: 4, open issues:0_
* **235** [cuckoofilter](https://github.com/seiflotfy/cuckoofilter) - Cuckoo filter: a good alternative to a counting bloom filter implemented in Go. ->  forks: 17, open issues:2_
* **74** [encoding](https://github.com/zhenjl/encoding) - Integer Compression Libraries for Go. ->  forks: 9, open issues:1_
* **21** [go-adaptive-radix-tree](https://github.com/plar/go-adaptive-radix-tree) - Go implementation of Adaptive Radix Tree. ->  forks: 4, open issues:0_
* **3389** [go-datastructures](https://github.com/Workiva/go-datastructures) - Collection of useful, performant, and thread-safe data structures. ->  forks: 333, open issues:8_
* **258** [go-geoindex](https://github.com/hailocab/go-geoindex) - In-memory geo index. ->  forks: 32, open issues:2_
* **71** [go-rquad](https://github.com/aurelien-rainone/go-rquad) - Region quadtrees with efficient point location and neighbour finding. ->  forks: 2, open issues:1_
* **3107** [gods](https://github.com/emirpasic/gods) - Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc. ->  forks: 270, open issues:9_
* **592** [golang-set](https://github.com/deckarep/golang-set) - Thread-Safe and Non-Thread-Safe high-performance sets for Go. ->  forks: 74, open issues:4_
* **4** [goset](https://github.com/zoumo/goset) - A useful Set collection implementation for Go. ->  forks: 1, open issues:0_
* **136** [goskiplist](https://github.com/ryszard/goskiplist) - Skip list implementation in Go. ->  forks: 30, open issues:1_
* **311** [gota](https://github.com/kniren/gota) - Implementation of dataframes, series, and data wrangling methods for Go. ->  forks: 36, open issues:10_
* **94** [hilbert](https://github.com/google/hilbert) - Go package for mapping values to and from space-filling curves, such as Hilbert and Peano curves. ->  forks: 11, open issues:2_
* **545** [hyperloglog](https://github.com/axiomhq/hyperloglog) - HyperLogLog implementation with Sparse, LogLog-Beta bias correction and TailCut space reduction. ->  forks: 17, open issues:0_
* **6** [levenshtein](https://github.com/agext/levenshtein) - Levenshtein distance and similarity metrics with customizable edit costs and Winkler-like bonus for common prefix. ->  forks: 0, open issues:0_
* **9** [levenshtein](https://github.com/agnivade/levenshtein) - Implementation to calculate levenshtein distance in Go. ->  forks: 1, open issues:0_
* **254** [mafsa](https://github.com/smartystreets/mafsa) - MA-FSA implementation with Minimal Perfect Hashing. ->  forks: 17, open issues:8_
* **7** [merkletree](https://github.com/cbergoon/merkletree) - Implementation of a merkle tree providing an efficient and secure verification of the contents of data structures. ->  forks: 0, open issues:0_
* **274** [roaring](https://github.com/RoaringBitmap/roaring) - Go package implementing compressed bitsets. ->  forks: 33, open issues:21_
* **40** [skiplist](https://github.com/gansidui/skiplist) - Skiplist implementation in Go. ->  forks: 8, open issues:1_
* **198** [trie](https://github.com/derekparker/trie) - Trie implementation in Go. ->  forks: 21, open issues:5_
* **45** [ttlcache](https://github.com/diegobernardes/ttlcache) - In-memory LRU string-interface{} map with expiration for golang. ->  forks: 5, open issues:1_
* **351** [willf/bloom](https://github.com/willf/bloom) - Go package implementing Bloom filters. ->  forks: 64, open issues:2_

## Database

*Databases implemented in Go.*

* **1048** [BigCache](https://github.com/allegro/bigcache) - Efficient key/value cache for gigabytes of data. ->  forks: 73, open issues:3_
* **6804** [bolt](https://github.com/boltdb/bolt) - Low-level key/value database for Go. ->  forks: 553, open issues:107_
* **1563** [buntdb](https://github.com/tidwall/buntdb) - Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support. ->  forks: 97, open issues:2_
* **312** [cache2go](https://github.com/muesli/cache2go) - In-memory key:value cache which supports automatic invalidation based on timeouts. ->  forks: 129, open issues:0_
* **10972** [cockroach](https://github.com/cockroachdb/cockroach) - Scalable, Geo-Replicated, Transactional Datastore. ->  forks: 1098, open issues:1052_
* **25** [couchcache](https://github.com/codingsince1985/couchcache) - RESTful caching micro-service backed by Couchbase server. ->  forks: 2, open issues:0_
* **3692** [dgraph](https://github.com/dgraph-io/dgraph) - Scalable, Distributed, Low Latency, High Throughput Graph Database. ->  forks: 189, open issues:64_
* **475** [diskv](https://github.com/peterbourgon/diskv) - Home-grown disk-backed key-value store. ->  forks: 46, open issues:2_
* **431** [eliasdb](https://github.com/krotik/eliasdb) - Dependency-free, transactional graph database with REST API, phrase search and SQL-like query language. ->  forks: 15, open issues:2_
* **27** [forestdb](https://github.com/couchbase/goforestdb) - Go bindings for ForestDB. ->  forks: 3, open issues:7_
* **233** [GCache](https://github.com/bluele/gcache) - Cache library with support for expirable Cache, LFU, LRU and ARC. ->  forks: 31, open issues:8_
* **68** [geocache](https://github.com/melihmucuk/geocache) - In-memory cache that is suitable for geolocation based applications. ->  forks: 2, open issues:0_
* **1061** [go-cache](https://github.com/pmylund/go-cache) - In-memory key:value store/cache (similar to Memcached) library for Go, suitable for single-machine applications. ->  forks: 195, open issues:27_
* **1740** [goleveldb](https://github.com/syndtr/goleveldb) - Implementation of the [LevelDB](https://github.com/google/leveldb) key/value database in the Go. ->  forks: 224, open issues:24_
* **5713** [groupcache](https://github.com/golang/groupcache) - Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases. ->  forks: 663, open issues:10_
* **11395** [influxdb](https://github.com/influxdb/influxdb) - Scalable datastore for metrics, events, and real-time analytics. ->  forks: 1625, open issues:555_
* **2222** [ledisdb](https://github.com/siddontang/ledisdb) - Ledisdb is a high performance NoSQL like Redis based on LevelDB. ->  forks: 262, open issues:83_
* **306** [levigo](https://github.com/jmhodges/levigo) - Levigo is a Go wrapper for LevelDB. ->  forks: 63, open issues:3_
* **346** [moss](https://github.com/couchbase/moss) - Moss is a simple LSM key-value storage engine written in 100% Go. ->  forks: 23, open issues:36_
* **139** [piladb](https://github.com/fern4lvarez/piladb) - Lightweight RESTful database engine based on stack data structures. ->  forks: 14, open issues:11_
* **11390** [prometheus](https://github.com/prometheus/prometheus) - Monitoring system and time series database. ->  forks: 1285, open issues:227_
* **3140** [rqlite](https://github.com/rqlite/rqlite) - The lightweight, distributed, relational database built on SQLite. ->  forks: 154, open issues:30_
* **70** [Scribble](https://github.com/nanobox-io/golang-scribble) - Tiny flat file JSON store. ->  forks: 19, open issues:5_
* **6** [tempdb](https://github.com/rafaeljesus/tempdb) - Key-value store for temporary items. ->  forks: 1, open issues:0_
* **9368** [tidb](https://github.com/pingcap/tidb) - TiDB is a distributed SQL database. Inspired by the design of Google F1. ->  forks: 1287, open issues:335_
* **1896** [tiedot](https://github.com/HouzuoGuo/tiedot) - Your NoSQL database powered by Golang. ->  forks: 169, open issues:14_
* **3337** [Tile38](https://github.com/tidwall/tile38) - Geolocation DB with spatial index and realtime geofencing. ->  forks: 156, open issues:44_

*Database schema migration.*

* **42** [darwin](https://github.com/GuiaBolso/darwin) - Database schema evolution library for Go. ->  forks: 4, open issues:0_
* **2** [go-fixtures](https://github.com/RichardKnop/go-fixtures) - Django style fixtures for Golang's excellent built-in database/sql library. ->  forks: 3, open issues:0_
* **48** [goose](https://github.com/steinbacher/goose) - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts. ->  forks: 7, open issues:5_
* **60** [gormigrate](https://github.com/go-gormigrate/gormigrate) - Database schema migration helper for Gorm ORM. ->  forks: 6, open issues:0_
* **1526** [migrate](https://github.com/mattes/migrate) - Database migrations. CLI and Golang library. ->  forks: 252, open issues:42_
* **18** [pravasan](https://github.com/pravasan/pravasan) - Simple Migration tool - currently for MySQL but planning to support soon for Postgres, SQLite, MongoDB, etc. ->  forks: 3, open issues:30_
...
* **743** [sql-migrate](https://github.com/rubenv/sql-migrate) - Database migration tool. Allows embedding migrations into the application using go-bindata. ->  forks: 78, open issues:31_

*Database tools.*

* **632** [go-mysql](https://github.com/siddontang/go-mysql) - Go toolset to handle MySQL protocol and replication. ->  forks: 166, open issues:20_
* **855** [go-mysql-elasticsearch](https://github.com/siddontang/go-mysql-elasticsearch) - Sync your MySQL data into Elasticsearch automatically. ->  forks: 202, open issues:52_
* **2884** [kingshard](https://github.com/flike/kingshard) - kingshard is a high performance proxy for MySQL powered by Golang. ->  forks: 589, open issues:43_
* **82** [myreplication](https://github.com/2tvenom/myreplication) - MySql binary log replication listener. Support statement and row based replication. ->  forks: 28, open issues:3_
* **839** [orchestrator](https://github.com/github/orchestrator) - MySQL replication topology manager & visualizer. ->  forks: 112, open issues:61_
* **4466** [pgweb](https://github.com/sosedoff/pgweb) - Web-based PostgreSQL database browser. ->  forks: 286, open issues:21_
* **1408** [pREST](https://github.com/nuveo/prest) - Serve a RESTful API from any PostgreSQL database. ->  forks: 45, open issues:22_
* **4929** [vitess](https://github.com/youtube/vitess) - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services. ->  forks: 645, open issues:111_

*SQL query builder, libraries for building and using SQL.*

* **456** [dat](https://github.com/mgutz/dat) - Go Postgres Data Access Toolkit. ->  forks: 38, open issues:25_
* **306** [Dotsql](https://github.com/gchaincl/dotsql) - Go library that helps you keep sql files in one place and use it with ease. ->  forks: 19, open issues:2_
* **334** [goqu](https://github.com/doug-martin/goqu) - Idiomatic SQL builder and query library. ->  forks: 33, open issues:9_
* **61** [igor](https://github.com/galeone/igor) - Abstraction layer for PostgreSQL that supports advanced functionality and uses gorm-like syntax. ->  forks: 2, open issues:0_
* **174** [ozzo-dbx](https://github.com/go-ozzo/ozzo-dbx) - Powerful data retrieval methods as well as DB-agnostic query building capabilities. ->  forks: 24, open issues:5_
* **109** [scaneo](https://github.com/variadico/scaneo) - Generate Go code to convert database rows into arbitrary structs. ->  forks: 8, open issues:3_
* **79** [sqrl](https://github.com/elgris/sqrl) - SQL query builder, fork of Squirrel with improved performance. ->  forks: 6, open issues:1_
* **1195** [Squirrel](https://github.com/Masterminds/squirrel) - Go library that helps you build SQL queries. ->  forks: 98, open issues:32_
* **1243** [xo](https://github.com/knq/xo) - Generate idiomatic Go code for databases based on existing schema definitions or custom queries supporting PostgreSQL, MySQL, SQLite, Oracle, and Microsoft SQL Server. ->  forks: 102, open issues:41_
...
* **32*    * [avatica](https://github.com/Boostport/avatica) - Apache Phoenix/Avatica SQL driver for database/sql. ->  forks: 7, open issues:0_
* **5*    * [bgc](https://github.com/viant/bgc) - Datastore Connectivity for BigQuery for go. ->  forks: 2, open issues:0_
* **64*    * [firebirdsql](https://github.com/nakagami/firebirdsql) - Firebird RDBMS SQL driver for Go. ->  forks: 15, open issues:9_
* **59*    * [go-adodb](https://github.com/mattn/go-adodb) - Microsoft ActiveX Object DataBase driver for go that using database/sql. ->  forks: 25, open issues:10_
* **130*    * [go-bqstreamer](https://github.com/rounds/go-bqstreamer) - BigQuery fast and concurrent stream insert. ->  forks: 14, open issues:5_
* **588*    * [go-mssqldb](https://github.com/denisenkom/go-mssqldb) - Microsoft MSSQL driver for Go. ->  forks: 121, open issues:50_
* **228*    * [go-oci8](https://github.com/mattn/go-oci8) - Oracle driver for go that using database/sql. ->  forks: 131, open issues:52_
* **4076*    * [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) - MySQL driver for Go. ->  forks: 882, open issues:61_
* **1964*    * [go-sqlite3](https://github.com/mattn/go-sqlite3) - SQLite3 driver for go that using database/sql. ->  forks: 448, open issues:68_
* **50*    * [gofreetds](https://github.com/minus5/gofreetds) - Microsoft MSSQL driver. Go wrapper over [FreeTDS](http://www.freetds.org). ->  forks: 25, open issues:10_
* **1093*    * [pgx](https://github.com/jackc/pgx) - PostgreSQL driver supporting features beyond those exposed by database/sql. ->  forks: 124, open issues:35_
* **3132*    * [pq](https://github.com/lib/pq) - Pure Go Postgres driver for database/sql. ->  forks: 427, open issues:122_

* NoSQL Databases
* **230*    * [aerospike-client-go](https://github.com/aerospike/aerospike-client-go) - Aerospike client in Go language. ->  forks: 93, open issues:10_
* **50*    * [arangolite](https://github.com/solher/arangolite) - Lightweight golang driver for ArangoDB. ->  forks: 14, open issues:3_
* **2*    * [asc](https://github.com/viant/asc) - Datastore Connectivity for Aerospike for go. ->  forks: 1, open issues:0_
* **10421*    * [cayley](https://github.com/google/cayley) - Graph database with support for multiple backends. ->  forks: 899, open issues:65_
* **4*    * [dsc](https://github.com/viant/dsc) - Datastore connectivity for SQL, NoSQL, structured files. ->  forks: 2, open issues:0_
...
* **246*    * [go-couchbase](https://github.com/couchbase/go-couchbase) - Couchbase client in Go. ->  forks: 78, open issues:31_
* **45*    * [go-couchdb](https://github.com/fjl/go-couchdb) - Yet another CouchDB HTTP API wrapper for Go. ->  forks: 22, open issues:16_
* **223*    * [gocb](https://github.com/couchbase/gocb) - Official Couchbase Go SDK. ->  forks: 58, open issues:0_
...
* **1217*    * [gorethink](https://github.com/dancannon/gorethink) - Go language driver for RethinkDB. ->  forks: 133, open issues:9_
...
* **22*    * [neo4j](https://github.com/cihangir/neo4j) - Neo4j Rest API Bindings for Golang. ->  forks: 3, open issues:8_
* **65*    * [Neo4j-GO](https://github.com/davemeehan/Neo4j-GO) - Neo4j REST Client in golang. ->  forks: 14, open issues:1_
...
* **1633*    * [elastic](https://github.com/olivere/elastic) - Elasticsearch client for Go. ->  forks: 378, open issues:25_
* **95*    * [elasticsql](https://github.com/cch123/elasticsql) - Convert sql to elasticsearch dsl in Go. ->  forks: 14, open issues:4_
...
* **124** [carbon](https://github.com/uniplaces/carbon) - Simple Time extension with a lot of util methods, ported from PHP Carbon library. ->  forks: 12, open issues:5_
* **38** [dateparse](https://github.com/araddon/dateparse) - Parse date's without knowing format in advance. ->  forks: 7, open issues:2_
...
* **26** [go-persian-calendar](https://github.com/yaa110/go-persian-calendar) - The implementation of the Persian (Solar Hijri) Calendar in Go (golang). ->  forks: 2, open issues:0_
* **12** [goweek](https://github.com/grsmv/goweek) - Library for working with week entity in golang. ->  forks: 3, open issues:0_
* **951** [now](https://github.com/jinzhu/now) - Now is a time toolkit for golang. ->  forks: 53, open issues:5_
* **3** [NullTime](https://github.com/kirillDanshin/nulltime) - Nullable `time.Time`. ->  forks: 1, open issues:0_
* **139** [timeutil](https://github.com/leekchan/timeutil) - Useful extensions (Timedelta, Strftime, ...) to the golang's time package. ->  forks: 4, open issues:0_
* **1** [tuesday](https://github.com/osteele/tuesday) - Ruby-compatible Strftime function. ->  forks: 0, open issues:1_

## Distributed Systems

*Packages that help with building Distributed Systems.*

* **26** [celeriac](https://github.com/svcavallar/celeriac.v1) - Library for adding support for interacting and monitoring Celery workers, tasks and events in Go. ->  forks: 3, open issues:0_
* **131** [digota](https://github.com/digota/digota) - grpc ecommerce microservice. ->  forks: 8, open issues:9_
* **18** [drmaa](https://github.com/dgruber/drmaa) - Job submission library for cluster schedulers based on the DRMAA standard. ->  forks: 10, open issues:0_
...
* **849** [gleam](https://github.com/chrislusf/gleam) - Fast and scalable distributed map/reduce system written in pure Go and Luajit, combining Go's high concurrency with Luajit's high performance, runs standalone or distributed. ->  forks: 87, open issues:5_
...
* **127** [go-jump](https://github.com/dgryski/go-jump) - Port of Google's "Jump" Consistent Hash function. ->  forks: 11, open issues:0_
* **7596** [go-kit](https://github.com/go-kit/kit) - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc. ->  forks: 752, open issues:33_
...
* **9** [jsonrpc](https://github.com/ybbus/jsonrpc) - JSON-RPC 2.0 HTTP client implementation. ->  forks: 2, open issues:0_
...
* **3500** [micro](https://github.com/micro/micro) - Pluggable microservice toolkit and distributed systems platform. ->  forks: 256, open issues:1_
...
* **1313** [raft](https://github.com/hashicorp/raft) - Golang implementation of the Raft consensus protocol, by HashiCorp. ->  forks: 167, open issues:56_
...
* **1385** [rpcx](https://github.com/smallnest/rpcx) - Distributed pluggable RPC service framework like alibaba Dubbo. ->  forks: 245, open issues:11_
...
* **624** [tendermint](https://github.com/tendermint/tendermint) - High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols. ->  forks: 128, open issues:108_
...
* **791** [email](https://github.com/jordan-wright/email) - A robust and flexible email library for Go. ->  forks: 90, open issues:24_
...
* **3** [go-gtfs](https://github.com/artonge/go-gtfs) - Load gtfs files in go. ->  forks: 0, open issues:0_
...
* **10** [skywalker](https://github.com/dixonwille/skywalker) - Package to allow one to concurrently go through a filesystem with ease. ->  forks: 1, open issues:0_
* **11** [tarfs](https://github.com/posener/tarfs) - Implementation of the [`FileSystem` interface](https://godoc.org/github.com/kr/fs#FileSystem) for tar files. ->  forks: 0, open issues:0_
